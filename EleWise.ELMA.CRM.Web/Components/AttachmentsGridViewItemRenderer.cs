...
// Type: EleWise.ELMA.CRM.Web.Components.AttachmentsGridViewItemRenderer
...
{
  [Component]
  public class AttachmentsGridViewItemRenderer : 
    ViewItemRendererBase<AttachmentsGridViewItem>,
    ICountViewItemRenderer
  {
    public long? Count(object model, ICountViewItem viewItem)
    {
      ...
      return new long?(EntityManager<ICRMAttachment>.Instance.Count((IEntityFilter) filter));
    }
  }
}
