...
// Type: EleWise.ELMA.CRM.Web.Components.FilterMarketingCalendarMenuProviderExtension
...
namespace EleWise.ELMA.CRM.Web.Components
{
  ...
  public class FilterMarketingCalendarMenuProviderExtension : IFilterMenuProviderExtension
  {
    ...
    public bool SupportedFilter(IFilterFolder filterFolder) => filterFolder.Uid == CrmConstants.CalendarActionFilter;
