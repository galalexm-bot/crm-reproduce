...
// Type: EleWise.ELMA.CRM.Web.Components.RelationMailEventAddAction
...
namespace EleWise.ELMA.CRM.Web.Components
{
  ...
  public class RelationMailEventAddAction : IEventAddAction
  {
    ...
    public string Url(RequestContext context) => new UrlHelper(context).Action("Create", "RelationshipMail", (object) new
    {
