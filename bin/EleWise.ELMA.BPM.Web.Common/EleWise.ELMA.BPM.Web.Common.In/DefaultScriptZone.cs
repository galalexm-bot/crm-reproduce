...
namespace EleWise.ELMA.BPM.Web.Common.Integration;
...
public class DefaultScriptZone : IExtensionZone
{
	...
	public void RenderZone(string zoneId, HtmlHelper html)
	{
		if ("EleWise.ELMA.SDK.Web.DefaultScripts.ZoneAfter" == zoneId)
		{
			...
			html.get_ViewContext().get_Writer().WriteLine(((HtmlString)(object)PartialExtensions.Partial(html, "UnitMeasure/UnitMeasureInfoDefaultScript")).ToHtmlString());
		}
	}
}
