...
[Component(Order = 10)]
public class ApprovalTaskStatusLinkDescription : ITaskStatusLinkDescription
{
	...
	public MvcHtmlString Description(HtmlHelper htmlHelper, ITaskBase task)
	{
		...
		string innerHtml = ((obj == true) ? SR.T("Задача согласования ({0})", ((HtmlString)(object)PartialExtensions.Partial(htmlHelper, "DisplayTemplates/Entities/User", (object)task.CreationAuthor)).ToHtmlString()) : SR.T("Задача согласования"));
