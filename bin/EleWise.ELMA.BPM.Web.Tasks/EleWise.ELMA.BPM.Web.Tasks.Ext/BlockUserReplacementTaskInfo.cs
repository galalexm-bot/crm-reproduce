...
internal class BlockUserReplacementTaskInfo : IExtensionZone
{
	...
	{
		if (zones.Contains(zoneId) && html.get_ViewData().get_Model() is TaskViewModel taskViewModel && taskViewModel.Entity is IReplacementTask replacementTask && replacementTask.IsBlockUserTask())
		{
			RenderPartialExtensions.RenderPartial(html, "ReplacementTask/BlockUserReplacementTaskInfo", (object)replacementTask);
		}
	}
}
