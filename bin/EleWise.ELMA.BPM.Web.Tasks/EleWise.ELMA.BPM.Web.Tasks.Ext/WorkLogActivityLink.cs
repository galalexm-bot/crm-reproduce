...
[Component]
public class WorkLogActivityLink : IEntityLink
{
	public Type EntityType => InterfaceActivator.TypeOf<IWorkLogActivity>();

	public Guid TypeUid => InterfaceActivator.UID<IWorkLogActivity>();
	...
	{
		return $"javascript:showWorkLogActivityInfo({entity.GetId()});";
	}
}
