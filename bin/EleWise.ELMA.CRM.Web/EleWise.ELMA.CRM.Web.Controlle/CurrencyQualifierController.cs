...
public class CurrencyQualifierController : BPMController
{
	...
	{
		ExchangeRateImportSettings exchangeRateImportSettings = new ExchangeRateImportSettings();
		return (ActionResult)(object)((Controller)this).View((object)exchangeRateImportSettings);
	}
	...
	public RedirectToRouteResult Import(string currencies = null, string[] itemsList = null)
	{
		...
		return ((Controller)this).RedirectToAction("Index", "CurrencyQualifier", (object)new
		{
	...
	public static List<ICurrency> Deserialize(string items)
	{
		...
		return source.Select((ExpandoObject s) => (ICurrency)serializer.ConvertFromSerializable(s, InterfaceActivator.TypeOf<ICurrency>())).ToList();
	}
	...
	public ActionResult CurrencyList(ExchangeRateImportSettings settings)
	{
		...
		return (ActionResult)(object)((Controller)this).PartialView((object)currencyImportModel);
	}

	public ActionResult CurrencyImportSettings(Guid guid)
	{
		ExchangeRateImportSettings exchangeRateImportSettings = new ExchangeRateImportSettings();
		exchangeRateImportSettings.Provider = guid;
		return (ActionResult)(object)((Controller)this).PartialView((object)exchangeRateImportSettings);
	}

	private ActionResult RedirectToIndexAjax()
	{
		return (ActionResult)(object)((Controller)this).Json((object)new
		{
			RedirectUrl = ((Controller)this).get_Url().Action("Index", (object)new
			{
				area = "EleWise.ELMA.CRM.Web"
			})
		});
