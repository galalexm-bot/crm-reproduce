...
[Component]
internal class FeedLeadUpdateProvider : FeedMessageUpdateProviderBase<ILead>
{
	protected override FeedPriority GetPriorityForRecipient(FeedModel feedModel, IUser recipient, ILead entity)
	{
		if (feedModel == null)
		{
