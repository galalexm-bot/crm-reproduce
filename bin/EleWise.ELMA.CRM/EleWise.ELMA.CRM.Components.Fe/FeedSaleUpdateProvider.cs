...
[Component]
internal class FeedSaleUpdateProvider : FeedMessageUpdateProviderBase<ISale>
{
	protected override FeedPriority GetPriorityForRecipient(FeedModel feedModel, IUser recipient, ISale entity)
	{
		if (feedModel == null)
		{
