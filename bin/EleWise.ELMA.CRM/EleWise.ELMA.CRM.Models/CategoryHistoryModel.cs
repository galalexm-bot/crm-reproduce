...
public class CategoryHistoryModel : HistoryBaseModel, IEditedHistoryModel<IContractor>, IHistoryBaseModel, IContractorHistoryBaseModel
{
	...
	public CategoryHistoryModel([NotNull] EntityActionEventArgs originalEvent, string actionTheme)
