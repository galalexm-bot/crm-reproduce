...
internal class __Resources_IContactPersonPermission
{
	public static string DisplayName => SR.T("Права на доступ к контакту");
	...
	public static string P_Contact_DisplayName => SR.T("Контакт");

	public static string P_InheritedFromNumber_DisplayName => SR.T("Унаследована от ");
}
