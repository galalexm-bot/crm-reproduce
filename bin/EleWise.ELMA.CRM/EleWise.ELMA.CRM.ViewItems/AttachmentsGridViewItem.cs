...
[Serializable]
[DisplayName(typeof(__Resources_AttachmentsGridViewItem), "DisplayName")]
...
public class AttachmentsGridViewItem : ViewItem, ICountViewItem
{
	[Component(Order = 81)]
	private class ToolboxItem : CRMViewItemToolboxItem<AttachmentsGridViewItem>
	{
	}
