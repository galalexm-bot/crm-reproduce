...
[Serializable]
[DisplayName(typeof(__Resources_RelationshipsGridViewItem), "DisplayName")]
...
public class RelationshipsGridViewItem : ViewItem, ICountViewItem
{
	[Component(Order = 51)]
	private class ToolboxItem : CRMViewItemToolboxItem<RelationshipsGridViewItem>
	{
	}
