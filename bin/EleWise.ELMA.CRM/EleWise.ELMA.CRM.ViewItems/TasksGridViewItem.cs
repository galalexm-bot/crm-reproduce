...
[Serializable]
[DisplayName(typeof(__Resources_TasksGridViewItem), "DisplayName")]
...
public class TasksGridViewItem : ViewItem, ICountViewItem
{
	[Component(Order = 71)]
	private class ToolboxItem : CRMViewItemToolboxItem<TasksGridViewItem>
	{
	}
