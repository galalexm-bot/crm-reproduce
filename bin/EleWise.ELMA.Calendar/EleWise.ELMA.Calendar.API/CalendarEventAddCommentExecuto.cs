...
public class CalendarEventAddCommentExecutor : PublicServiceMethodExecutor
{
	...
	public CalendarEventAddCommentExecutor(WebData parameters)
		: base(parameters)
	{
	}
	...
	protected virtual WebData ExecuteInternal()
	{
		...
		ICalendarEvent calendarEvent = CalendarEventManager.Instance.Load(result);
	...
	protected virtual void BindAdditionalData(WebData parameters, ICommentActionModel actionModel, ICalendarEvent calendarEvent)
	{
	...
	public virtual void DoTaskAction(ICommentActionModel actionModel, ICalendarEvent calendarEvent)
	{
		DoAddCommentAction(actionModel, calendarEvent, CalendarEventActions.AddCommentGuid);
	}

	protected static void DoAddCommentAction(ICommentActionModel actionModel, ICalendarEvent calendarEvent, Guid actionGuid)
	{
		...
		try
		{
			...
			CalendarEventManager.Instance.Save(calendarEvent);
