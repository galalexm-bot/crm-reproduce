...
public class UserSelected
{
	...
	[Template("React.createElement(elmaComponents.EntityUserSelected, {props}, {children})")]
	public extern UserSelected(Props props, params Union<ReactElement, string>[] children);

	public static implicit operator ReactElement(UserSelected source)
	{
		return Script.Write<ReactElement>("source", new object[0]);
	}

	public static implicit operator Union<ReactElement, string>(UserSelected source)
	{
