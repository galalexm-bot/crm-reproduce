...
[Service]
internal sealed class ComponentMetadataCacheService : CacheService, IComponentMetadataCacheService
{
	[StructLayout(3)]
	private struct _003CGetFromCache_003Ed__5 : IAsyncStateMachine
	{
		...
		public AsyncTaskMethodBuilder<System.Collections.Generic.IEnumerable<RuntimeComponentModel>> _003C_003Et__builder;

		public ComponentMetadataCacheService _003C_003E4__this;

		public System.Collections.Generic.IEnumerable<Guid> metadataUidList;

		private RuntimeComponentModel[] _003CmetadataList_003E5__2;
		...
		private void MoveNext()
		{
			...
			ComponentMetadataCacheService componentMetadataCacheService = _003C_003E4__this;
			System.Collections.Generic.IEnumerable<RuntimeComponentModel> result;
			try
			{
				...
				_003CmetadataList_003E5__2 = (RuntimeComponentModel[])(object)new RuntimeComponentModel[0];
				if (!componentMetadataCacheService.IsDevServer)
				{
					val = componentMetadataCacheService.GetValues(Enumerable.Select<Guid, string>(metadataUidList, (Func<Guid, string>)GetKey).ToArray()).GetAwaiter();
				...
				{
					ArrayExtensions.Push<RuntimeComponentModel>(_003CmetadataList_003E5__2, (RuntimeComponentModel[])(object)new RuntimeComponentModel[1] { ObjectExtensions.As<RuntimeComponentModel>(ConvertHelper.DeserializeWithType(typeof(RuntimeComponentModel), value, componentMetadataCacheService.ConvertContext)) });
				}
				result = _003CmetadataList_003E5__2;
				end_IL_000e:;
			}
	...
	private struct _003CGetDifferenceMetadataUids_003Ed__6 : IAsyncStateMachine
	{
		...
		private void MoveNext()
		{
			...
			try
			{
				...
				if (metadataUidList != null && !componentMetadataCacheService.IsDevServer)
				{
					val = componentMetadataCacheService.GetMetadataUids().GetAwaiter();
					if (!val.get_IsCompleted())
					{
						num = (_003C_003E1__state = 0);
						_003C_003Eu__1 = val;
	...
	private struct _003CGetMetadataUids_003Ed__7 : IAsyncStateMachine
	{
		...
		private void MoveNext()
		{
			...
			try
			{
				...
				if (num != 0)
				{
					val = componentMetadataCacheService.GetAllKeys().GetAwaiter();
					if (!val.get_IsCompleted())
					{
						num = (_003C_003E1__state = 0);
						_003C_003Eu__1 = val;
	...
	private const string StorageName = "ComponentMetadataStore";

	protected override string StoreName => "ComponentMetadataStore";

	private bool IsDevServer => base.ApplicationData.InterfaceBuilderMode == InterfaceBuilderMode.DevServer;

	public ComponentMetadataCacheService(IApplicationData applicationData, ILazy<IExtendEntityService> extendEntityServiceLazy, ILazy<IProxyGeneratorService> proxyGeneratorServiceLazy)
		: base(applicationData, extendEntityServiceLazy, proxyGeneratorServiceLazy)
	{
	}

	public void Cache(System.Collections.Generic.ICollection<RuntimeComponentModel> componentModels)
	{
		...
		System.Collections.Generic.IEnumerator<RuntimeComponentModel> enumerator = ((System.Collections.Generic.IEnumerable<RuntimeComponentModel>)componentModels).GetEnumerator();
		try
		{
			while (((System.Collections.IEnumerator)enumerator).MoveNext())
			{
				RuntimeComponentModel current = enumerator.get_Current();
				ComponentMetadataItem metadataItem = current.get_MetadataItem();
				if (metadataItem.get_IsPublished() && !metadataItem.get_IsEmulation())
				{
					object value = ((object)current).get_Item("$jsonObj");
					Set(GetKey(metadataItem.get_Uid()), value);
				}
			}
		}
		finally
	...
	public System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<RuntimeComponentModel>> GetFromCache(System.Collections.Generic.IEnumerable<Guid> metadataUidList)
	{
		...
		_003CGetFromCache_003Ed__._003C_003Et__builder = AsyncTaskMethodBuilder<System.Collections.Generic.IEnumerable<RuntimeComponentModel>>.Create();
		_003CGetFromCache_003Ed__._003C_003E1__state = -1;
		AsyncTaskMethodBuilder<System.Collections.Generic.IEnumerable<RuntimeComponentModel>> _003C_003Et__builder = _003CGetFromCache_003Ed__._003C_003Et__builder;
