...
[Service]
internal sealed class ModuleMetadataCacheService : CacheService, IModuleMetadataCacheService
{
	[StructLayout(3)]
	private struct _003CGetFromCache_003Ed__5 : IAsyncStateMachine
	{
		...
		public AsyncTaskMethodBuilder<System.Collections.Generic.IEnumerable<RuntimeModuleModel>> _003C_003Et__builder;

		public ModuleMetadataCacheService _003C_003E4__this;

		public System.Collections.Generic.IEnumerable<Guid> metadataUidList;

		private RuntimeModuleModel[] _003CmetadataList_003E5__2;
		...
		private void MoveNext()
		{
			...
			ModuleMetadataCacheService moduleMetadataCacheService = _003C_003E4__this;
			System.Collections.Generic.IEnumerable<RuntimeModuleModel> result;
			try
			{
				...
				_003CmetadataList_003E5__2 = (RuntimeModuleModel[])(object)new RuntimeModuleModel[0];
				if (!moduleMetadataCacheService.IsDevServer)
				{
					val = moduleMetadataCacheService.GetValues(Enumerable.Select<Guid, string>(metadataUidList, (Func<Guid, string>)GetKey).ToArray()).GetAwaiter();
				...
				{
					ArrayExtensions.Push<RuntimeModuleModel>(_003CmetadataList_003E5__2, (RuntimeModuleModel[])(object)new RuntimeModuleModel[1] { ObjectExtensions.As<RuntimeModuleModel>(ConvertHelper.DeserializeWithType(typeof(RuntimeModuleModel), value, moduleMetadataCacheService.ConvertContext)) });
				}
				result = _003CmetadataList_003E5__2;
				end_IL_000e:;
			}
	...
	private struct _003CGetDifferenceMetadataUids_003Ed__6 : IAsyncStateMachine
	{
		...
		private void MoveNext()
		{
			...
			try
			{
				...
				if (metadataUidList != null && !moduleMetadataCacheService.IsDevServer)
				{
					val = moduleMetadataCacheService.GetMetadataUids().GetAwaiter();
					if (!val.get_IsCompleted())
					{
						num = (_003C_003E1__state = 0);
						_003C_003Eu__1 = val;
	...
	private struct _003CGetMetadataUids_003Ed__7 : IAsyncStateMachine
	{
		...
		private void MoveNext()
		{
			...
			try
			{
				...
				if (num != 0)
				{
					val = moduleMetadataCacheService.GetAllKeys().GetAwaiter();
					if (!val.get_IsCompleted())
					{
						num = (_003C_003E1__state = 0);
						_003C_003Eu__1 = val;
	...
	private const string StorageName = "ModuleMetadataStore";

	protected override string StoreName => "ModuleMetadataStore";

	private bool IsDevServer => base.ApplicationData.InterfaceBuilderMode == InterfaceBuilderMode.DevServer;

	public ModuleMetadataCacheService(IApplicationData applicationData, ILazy<IExtendEntityService> extendEntityServiceLazy, ILazy<IProxyGeneratorService> proxyGeneratorServiceLazy)
		: base(applicationData, extendEntityServiceLazy, proxyGeneratorServiceLazy)
	{
	}

	public void Cache(System.Collections.Generic.ICollection<RuntimeModuleModel> modules)
	{
		...
		System.Collections.Generic.IEnumerator<RuntimeModuleModel> enumerator = ((System.Collections.Generic.IEnumerable<RuntimeModuleModel>)modules).GetEnumerator();
		try
		{
			while (((System.Collections.IEnumerator)enumerator).MoveNext())
			{
	...
	public System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<RuntimeModuleModel>> GetFromCache(System.Collections.Generic.IEnumerable<Guid> metadataUidList)
	{
		...
		_003CGetFromCache_003Ed__._003C_003Et__builder = AsyncTaskMethodBuilder<System.Collections.Generic.IEnumerable<RuntimeModuleModel>>.Create();
		_003CGetFromCache_003Ed__._003C_003E1__state = -1;
		AsyncTaskMethodBuilder<System.Collections.Generic.IEnumerable<RuntimeModuleModel>> _003C_003Et__builder = _003CGetFromCache_003Ed__._003C_003Et__builder;
