...
[Component(Order = 450)]
internal sealed class Document1CDescriptorTree : TypeDescriptorTree
{
	...
	public Document1CDescriptorTree(IMetadataServiceContext metadataService, MetadataItemGroupManager metadataItemGroupManager)
	{
	...
	{
		return typeDescriptor is Document1CDescriptor;
	}
	...
	public override System.Threading.Tasks.Task<System.Collections.Generic.IEnumerable<ITypeDescriptor>> GetSubTypes(ITypeDescriptor typeDescriptor, ITypeDescriptorTreeFilterModel filterModel)
	{
		...
		System.Collections.Generic.IEnumerable<MetadataHeader> subTypes = EntityDescriptorTree.GetSubTypes(metadataService, filterModel, MetadataConstants.Document1CMetadataTypeUid);
