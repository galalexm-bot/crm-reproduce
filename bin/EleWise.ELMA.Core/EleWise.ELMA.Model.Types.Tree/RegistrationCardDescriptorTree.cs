...
[Component(Order = 399)]
internal sealed class RegistrationCardDescriptorTree : EntityDescriptorTree
{
	...
	private struct _003CGetSubTypes_003Ed__3 : IAsyncStateMachine
	{
		...
		public RegistrationCardDescriptorTree _003C_003E4__this;
		...
		private void MoveNext()
		{
			...
			RegistrationCardDescriptorTree registrationCardDescriptorTree = _003C_003E4__this;
			...
			try
			{
				...
				if (num != 0)
				{
					...
					_003CmetadataList_003E5__2 = Enumerable.ToArray<MetadataHeader>(registrationCardDescriptorTree.GetSubTypes(filterModel));
					...
					val2 = registrationCardDescriptorTree.documentMetadataHeadService.GetActiveDocumentTypeUids(MetadataConstants.RegistrationCardMetadataTypeUid).GetAwaiter();
				...
				goto IL_0103;
				IL_0103:
				val = CompositeTypeDescriptorHelper.GetDescriptorsByGroups(typeDescriptor, _003CmetadataList_003E5__2, registrationCardDescriptorTree.metadataItemGroupManager, registrationCardDescriptorTree.metadataService).GetAwaiter();
	...
	public RegistrationCardDescriptorTree(IMetadataServiceContext metadataService, MetadataItemGroupManager metadataItemGroupManager, IDocumentMetadataHeadService documentMetadataHeadService)
	...
	{
		return typeDescriptor is RegistrationCardTypeDescriptor;
	}
	...
	{
		//IL_0007: Unknown result type (might be due to invalid IL or missing references)
		return EntityDescriptorTree.GetSubTypes(metadataService, filterModel, MetadataConstants.RegistrationCardMetadataTypeUid);
	}
}
