...
[Component]
internal sealed class BlobDescriptor : CLRTypeDescriptor<byte[], BlobSettings>
{
	...
	private sealed class _003C_003Ec
	{
		...
		internal object _003CPropertyGetter_003Eb__8_0(GetterInfo getterInfo, PropertyInfo info)
		{
			...
			return ConvertHelper.GetByteArray(getterInfo.Target, CS_0024_003C_003E8__locals0.info.Expression, CS_0024_003C_003E8__locals0.info.ShouldSerialize, () => CS_0024_003C_003E8__locals0.info.InitValue);
		}
		...
		internal void _003CPropertySetter_003Eb__9_0(SetterInfo setterInfo, PropertyInfo info)
		{
			...
			CS_0024_003C_003E8__locals0.info = info;
			ConvertHelper.SetByteArray(setterInfo.Target, CS_0024_003C_003E8__locals0.info.Expression, (byte[])setterInfo.Value, CS_0024_003C_003E8__locals0.info.ShouldSerialize, () => CS_0024_003C_003E8__locals0.info.InitValue);
		}
	}
	...
	public static readonly Guid UID = TypeConstants.BlobUid;

	public override Guid Uid => UID;

	public override string Name => SR.T("Бинарные данные");

	public override Guid ParentUid => SystemTypesDescriptor.UID;

	public BlobDescriptor(ILogger logger)
		: base(logger)
	{
	}
