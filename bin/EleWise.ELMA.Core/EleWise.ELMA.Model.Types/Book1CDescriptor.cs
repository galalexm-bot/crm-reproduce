...
[Component(Order = 450)]
internal sealed class Book1CDescriptor : CLRTypeDescriptor<Entity, Book1CTypeSettings>
{
	...
	internal static readonly Guid UID = TypeConstants.Book1CUid;

	public override Guid Uid => UID;

	public override string Name => SR.T("Справочник 1С");

	public override Guid ParentUid => Guid.Empty;

	public Book1CDescriptor(ILogger logger)
		: base(logger)
	{
	}
