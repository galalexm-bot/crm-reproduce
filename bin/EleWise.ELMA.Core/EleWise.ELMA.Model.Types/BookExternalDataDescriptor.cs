...
[Component(Order = 460)]
internal sealed class BookExternalDataDescriptor : CLRTypeDescriptor<Entity, BookExternalDataTypeSettings>
{
	...
	internal static readonly Guid UID = TypeConstants.BookExternalDataUid;

	public override Guid Uid => UID;

	public override string Name => SR.T("Внешний справочник");

	public override Guid ParentUid => Guid.Empty;

	public BookExternalDataDescriptor(ILogger logger)
		: base(logger)
	{
	}
