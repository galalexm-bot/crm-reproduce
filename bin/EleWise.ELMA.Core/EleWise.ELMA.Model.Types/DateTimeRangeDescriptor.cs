...
public class DateTimeRangeDescriptor : RangeTypeDescriptor<DateTimeRange, System.DateTime, DateTimeSettings>
{
	...
	private sealed class _003C_003Ec
	{
		...
		internal object _003CPropertyGetter_003Eb__8_0(GetterInfo getterInfo, PropertyInfo info)
		{
			...
			return ConvertHelper.GetDateTimeRange(getterInfo.Target, CS_0024_003C_003E8__locals0.info.Expression, CS_0024_003C_003E8__locals0.info.ShouldSerialize, () => CS_0024_003C_003E8__locals0.info.InitValue);
		}
		...
		internal void _003CPropertySetter_003Eb__9_0(SetterInfo setterInfo, PropertyInfo info)
		{
			...
			CS_0024_003C_003E8__locals0.info = info;
			ConvertHelper.SetDateTimeRange(setterInfo.Target, CS_0024_003C_003E8__locals0.info.Expression, (DateTimeRange?)setterInfo.Value, CS_0024_003C_003E8__locals0.info.ShouldSerialize, () => CS_0024_003C_003E8__locals0.info.InitValue);
		}
	}
	...
	public static readonly Guid UID = TypeConstants.DateTimeRangeUid;

	public override Guid Uid => UID;

	public override string Name => SR.T("Дата / время (Диапазон)");

	public DateTimeRangeDescriptor(ILogger logger)
		: base(logger)
	{
	}

	protected override object GetFromValue(DateTimeRange value)
	{
		return value.From;
	}

	protected override object GetToValue(DateTimeRange value)
	{
		return value.To;
	}
