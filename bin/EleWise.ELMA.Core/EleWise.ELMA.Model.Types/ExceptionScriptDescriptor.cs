...
internal sealed class ExceptionScriptDescriptor : CLRTypeDescriptor<ExceptionData, ExceptionDataSettings>
{
	...
	private sealed class _003C_003Ec
	{
		...
		internal object _003CPropertyGetter_003Eb__6_0(GetterInfo getterInfo, PropertyInfo info)
		{
			...
			return ConvertHelper.GetExceptionData(getterInfo.Target, CS_0024_003C_003E8__locals0.info.Expression, CS_0024_003C_003E8__locals0.info.ShouldSerialize, () => CS_0024_003C_003E8__locals0.info.InitValue);
		}
		...
		internal void _003CPropertySetter_003Eb__7_0(SetterInfo setterInfo, PropertyInfo info)
		{
			...
			CS_0024_003C_003E8__locals0.info = info;
			ConvertHelper.SetExceptionData(setterInfo.Target, CS_0024_003C_003E8__locals0.info.Expression, (ExceptionData)setterInfo.Value, CS_0024_003C_003E8__locals0.info.ShouldSerialize, () => CS_0024_003C_003E8__locals0.info.InitValue);
		}
	}
	...
	public static readonly Guid UID = TypeConstants.ExceptionScriptUid;

	public override Guid Uid => UID;

	public override string Name => SR.T("Ошибка выполнения сценария");

	public ExceptionScriptDescriptor(ILogger logger)
		: base(logger)
	{
	}
