...
public class ReferenceOnEntityDescriptor : CLRTypeDescriptor<ReferenceOnEntity, ReferenceOnEntitySettings>
{
	...
	private sealed class _003C_003Ec
	{
		...
		internal object _003CPropertyGetter_003Eb__8_0(GetterInfo getterInfo, PropertyInfo info)
		{
			...
			return ConvertHelper.GetReferenceOnEntity(getterInfo.Target, CS_0024_003C_003E8__locals0.info.Expression, CS_0024_003C_003E8__locals0.info.ShouldSerialize, () => CS_0024_003C_003E8__locals0.info.InitValue);
		}
		...
		internal void _003CPropertySetter_003Eb__9_0(SetterInfo setterInfo, PropertyInfo info)
		{
			...
			CS_0024_003C_003E8__locals0.info = info;
			ConvertHelper.SetReferenceOnEntity(setterInfo.Target, CS_0024_003C_003E8__locals0.info.Expression, (ReferenceOnEntity)setterInfo.Value, CS_0024_003C_003E8__locals0.info.ShouldSerialize, () => CS_0024_003C_003E8__locals0.info.InitValue);
		}
	}
	...
	public static readonly Guid UID = TypeConstants.ReferenceOnEntityUid;

	public override Guid Uid => UID;

	public override string Name => SR.T("Ссылка на объект");

	public override Guid ParentUid => SystemTypesDescriptor.UID;

	public ReferenceOnEntityDescriptor(ILogger logger)
		: base(logger)
	{
	}
