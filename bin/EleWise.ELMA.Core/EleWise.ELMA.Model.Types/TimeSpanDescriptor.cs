...
[Component(Order = 700)]
public class TimeSpanDescriptor : CLRTypeDescriptor<TimeSpan, TimeSpanSettings>
{
	...
	private sealed class _003C_003Ec
	{
		...
		internal object _003CPropertyGetter_003Eb__6_0(GetterInfo getterInfo, PropertyInfo info)
		{
			...
			return ConvertHelper.GetNullableTimeSpan(getterInfo.Target, CS_0024_003C_003E8__locals0.info.Expression, CS_0024_003C_003E8__locals0.info.ShouldSerialize, () => CS_0024_003C_003E8__locals0.info.InitValue);
		}
		...
		internal object _003CPropertyGetter_003Eb__6_1(GetterInfo getterInfo, PropertyInfo info)
		{
			...
			CS_0024_003C_003E8__locals0.info = info;
			return ConvertHelper.GetTimeSpan(getterInfo.Target, CS_0024_003C_003E8__locals0.info.Expression, CS_0024_003C_003E8__locals0.info.ShouldSerialize, () => CS_0024_003C_003E8__locals0.info.InitValue);
		}
		...
		internal void _003CPropertySetter_003Eb__7_0(SetterInfo setterInfo, PropertyInfo info)
		{
			...
			CS_0024_003C_003E8__locals0.info = info;
			ConvertHelper.SetNullableTimeSpan(setterInfo.Target, CS_0024_003C_003E8__locals0.info.Expression, (TimeSpan?)setterInfo.Value, CS_0024_003C_003E8__locals0.info.ShouldSerialize, () => CS_0024_003C_003E8__locals0.info.InitValue);
		}
		...
		internal void _003CPropertySetter_003Eb__7_1(SetterInfo setterInfo, PropertyInfo info)
		{
			...
			CS_0024_003C_003E8__locals0.info = info;
			object obj = setterInfo.Value ?? ((object)default(TimeSpan));
			ConvertHelper.SetTimeSpan(setterInfo.Target, CS_0024_003C_003E8__locals0.info.Expression, (TimeSpan)obj, CS_0024_003C_003E8__locals0.info.ShouldSerialize, () => CS_0024_003C_003E8__locals0.info.InitValue);
		}
	}
	...
	public static readonly Guid UID = TypeConstants.TimeSpanUid;

	public override Guid Uid => UID;

	public override string Name => SR.T("Временной интервал");

	public TimeSpanDescriptor(ILogger logger)
		: base(logger)
	{
	}
	...
	{
		TimeSpanSettings obj = ObjectExtensions.As<TimeSpanSettings>((object)base.CreateSettings());
		obj.set_ShowDays(true);
		obj.set_ShowHours(true);
		obj.set_ShowMinutes(true);
	...
	{
		TimeSpanSettings obj = ObjectExtensions.As<TimeSpanSettings>((object)typeSettings);
		TimeSpanSettings val = ObjectExtensions.As<TimeSpanSettings>((object)newSettings);
		obj.set_ShowDays(val.get_ShowDays());
		obj.set_ShowHours(val.get_ShowHours());
		obj.set_ShowMinutes(val.get_ShowMinutes());
		obj.set_ShowSeconds(val.get_ShowSeconds());
	}
}
