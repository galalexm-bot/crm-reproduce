...
[Component]
public class DocumentDefaultSelectedColumnsProvider : IDefaultSelectedColumnsProvider
{
	...
	public List<KeyValuePair<PropertyMetadata, EntityMetadata>> GetProperties()
	{
		...
		PropertyMetadata propertyMetadata = entityMetadata.Properties.FirstOrDefault((PropertyMetadata p) => p.Name == "CurrentVersion");
