...
[Component]
public class DocumentFilterPropertiesZoneRenderer : IFilterPropertiesZoneRenderer
{
	public Guid ZoneUid => DocumentFilterPropertiesZoneTab.UID;
	...
	public void Render(HtmlHelper html, FilterPropertiesZone zone)
	{
		...
		RenderPartialExtensions.RenderPartial(html, "FilterDocument/DocumentFilterMainZone", (object)zone, val2);
	}
}
