...
[Component]
public class DocumentsTypeEQLZonePanelRenderer : IFilterPropertiesZoneRenderer
{
	public Guid ZoneUid => DocumentsTypeEQLZonePanel.UID;
	...
	public void Render(HtmlHelper html, FilterPropertiesZone zone)
	{
		...
		RenderPartialExtensions.RenderPartial(html, "FilterDocument/DocumentsTypeEQLZone", (object)zone, val2);
	}
}
