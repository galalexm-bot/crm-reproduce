...
[Component(Order = 99)]
internal sealed class DocumentVersionBinaryFileParentEntity : IBinaryFileParentEntity
{
	public IEntity GetEntity(BinaryFile file)
	{
		...
		return documentVersion.CastAsRealType();
	}

	public SystemException CreateEncryptException(object id)
	{
		return new EncryptDocumentVersionException(Convert.ToInt64(id));
	}
}
