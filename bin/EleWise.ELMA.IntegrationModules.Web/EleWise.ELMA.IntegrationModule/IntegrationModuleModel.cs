...
public class IntegrationModuleModel
{
	...
	public IntegrationModuleMetadata Metadata { get; set; }

	public IIntegrationModule Entity { get; set; }

	public ViewType ViewType { get; set; }

	public string FormId { get; set; }

	public string WebApiUrlBase { get; set; }
