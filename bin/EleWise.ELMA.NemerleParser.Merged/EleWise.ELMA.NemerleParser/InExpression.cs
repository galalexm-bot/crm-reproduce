...
{
	private class _N_Enumerable_8230 : IEnumerator, IDisposable, IEnumerator<TreeItem>, IEnumerable, IEnumerable<TreeItem>
	{
		internal TreeItem _N_current;

		internal int _N_state;

		internal Function<bool> _N__N_yielding_function_8255;

		internal InExpression _N__N_closurised_this_ptr_8253;

		internal Function<bool> _N__N_wildcard_3441_8251;
		...
		public bool MoveNext()
		{
			try
			{
				...
				if (_N_state != 1)
				{
					...
					_N_current = _N__N_closurised_this_ptr_8253.Expression;
					_N_state = 1;
					return true;
				}
				return false;
		...
		public IEnumerator<TreeItem> GetEnumerator()
		{
			...
			{
				_N_Enumerable_8230 n_Enumerable_ = new _N_Enumerable_8230();
		...
		private void CopyFrom(_N_Enumerable_8230 other)
		{
			_N_this_used = 1;
			_N__N_closurised_this_ptr_8253 = other._N__N_closurised_this_ptr_8253;
		}
	...
	{
		_N_Enumerable_8230 n_Enumerable_ = new _N_Enumerable_8230();
		n_Enumerable_._N__N_closurised_this_ptr_8253 = this;
