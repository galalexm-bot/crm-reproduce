...
public class ActivatingFilter<TPart> : IContentActivatingFilter, IContentFilter where TPart : ContentPart, new()
{
	...
	public ActivatingFilter(params string[] contentTypes)
		: this((Func<string, bool>)((string contentType) => contentTypes.Contains(contentType)))
	{
	}
