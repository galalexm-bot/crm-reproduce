...
public class ShapeTableBuilder
{
	...
	{
		ShapeAlterationBuilder shapeAlterationBuilder = new ShapeAlterationBuilder(_feature, shapeType);
		_alterationBuilders.Add(shapeAlterationBuilder);
		return shapeAlterationBuilder;
	}

	public IEnumerable<ShapeAlteration> BuildAlterations()
	{
		return _alterationBuilders.Select((ShapeAlterationBuilder b) => b.Build());
	}
}
