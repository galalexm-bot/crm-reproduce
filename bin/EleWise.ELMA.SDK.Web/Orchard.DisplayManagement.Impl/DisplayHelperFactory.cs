...
public class DisplayHelperFactory : IDisplayHelperFactory, IDependency
{
	...
	{
		return new DisplayHelper(_displayManager, _shapeFactory, viewContext, viewDataContainer);
	}
}
