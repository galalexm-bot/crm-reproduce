...
public class NavigationBuilder
{
	...
	public NavigationBuilder Add(LocalizedString caption, string position, Action<NavigationItemBuilder> itemBuilder, IEnumerable<string> classes = null)
	{
		...
		navigationItemBuilder.Caption(caption);
		navigationItemBuilder.Position(position);
		itemBuilder(navigationItemBuilder);
		Contained.AddRange(navigationItemBuilder.Build());
		if (classes != null)
		{
			foreach (string @class in classes)
			{
				navigationItemBuilder.AddClass(@class);
			}
			return this;
		}
		return this;
	...
	{
		return Add(caption, position, delegate
		{
		}, classes);
	}
	...
	{
		return Add(caption, null, delegate
		{
		}, classes);
	}
	...
	{
		IEnumerable<MenuItem> contained = Contained;
