...
public class NavigationItemBuilder : NavigationBuilder
{
	...
	{
		_item.Permissions = _item.Permissions.Concat(new Permission[1] { permission });
		return this;
	}
	...
	public NavigationItemBuilder Action(RouteValueDictionary values)
	{
		if (values == null)
		{
			return Action(null, null, new RouteValueDictionary());
		}
		return Action(values["action"] as string, values["controller"] as string, values);
	}
