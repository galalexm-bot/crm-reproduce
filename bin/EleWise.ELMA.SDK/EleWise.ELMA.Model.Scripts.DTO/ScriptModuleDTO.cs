...
public class ScriptModuleDTO : EntityDTO<long>, IScriptModule
{
	...
	public bool NeedUpdateSourceCode
	{
		...
		get
		{
			return _003CNeedUpdateSourceCode_003Ek__BackingField;
		}
		[CompilerGenerated]
		set
		{
			...
			while (true)
			{
				...
				case 0:
					return;
				case 1:
					_003CNeedUpdateSourceCode_003Ek__BackingField = value;
					num2 = 0;
	...
	public string SourceCodeFileName
	{
		...
		get
		{
			return _003CSourceCodeFileName_003Ek__BackingField;
		}
		[CompilerGenerated]
		set
		{
			...
			while (true)
			{
				...
				case 0:
					return;
				case 1:
					_003CSourceCodeFileName_003Ek__BackingField = value;
					num2 = 0;
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 3:
					...
					continue;
				case 1:
					CRTuW8bKOa0ObP5at3HW(this, new RootCodeItemCollection());
					num2 = 2;
					continue;
				case 5:
				...
				case 2:
					break;
				case 4:
					tLXy33bKeXdNj8PQDBm0(this, G1cVMcbK2aTDGumR3ly5(0x1DE3DD89 ^ 0x1DE11D27));
					num2 = 3;
					continue;
				case 7:
			...
			Namespace = (string)G1cVMcbK2aTDGumR3ly5(0x3B36AB09 ^ 0x3B36E85B);
			num = 4;
		}
	}
	...
	public override void CopyChanges(EntityDTO<long> saved)
	{
		...
		{
			Uid = scriptModuleDTO.Uid;
		}
	}

	internal static void CRTuW8bKOa0ObP5at3HW(object P_0, object P_1)
	{
		((ScriptModuleDTO)P_0).CodeItems = (RootCodeItemCollection)P_1;
	}

	internal static object G1cVMcbK2aTDGumR3ly5(int _0020)
	{
		return z2jc63fLkugS1X8Q9N.tE1kD1vbB(_0020);
	}

	internal static void tLXy33bKeXdNj8PQDBm0(object P_0, object P_1)
	{
		((ScriptModuleDTO)P_0).References = (string)P_1;
	}

	internal static bool YcJOLDbKk75LLyPtdu0H()
	{
		return hOSKrMbKTRrDLFnpxF4F == null;
	}

	internal static ScriptModuleDTO CeOxc3bKnN2BOeIuCNuT()
	{
		return hOSKrMbKTRrDLFnpxF4F;
	}
}
