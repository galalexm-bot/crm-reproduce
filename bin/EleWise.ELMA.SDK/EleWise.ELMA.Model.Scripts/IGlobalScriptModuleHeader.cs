...
[Uid("9fb8f30f-4c1a-4db6-97db-cefc39b5448d")]
...
public interface IGlobalScriptModuleHeader : IEntity<long>, IEntity, IIdentified
{
	...
	[EntityProperty]
	[Uid("efa2f923-b6a6-4bbc-afd4-8fc13960976b")]
	Guid Uid { get; set; }
	...
	[Order(1)]
	[Uid("8ef23861-9f2c-41eb-a98e-a2761f9eb5ee")]
	...
	[Order(4)]
	[Uid("fb8fe2ff-095c-4bc7-924b-ad3fe82a8ea3")]
	[View(ViewType = ViewType.Create, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
	...
	[EntityProperty]
	[View(ViewType = ViewType.Filter, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
	[Uid("da96c379-dc53-4a22-8e82-9051639a34c3")]
	[Order(5)]
	[Property("72ed98ca-f260-4671-9bcd-ff1d80235f47", "e5f6d1e3-6b00-4fae-ae1a-4d75a4126429")]
	...
	[View(ViewType = ViewType.Display, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = true)]
	[EntityProperty]
	[Uid("41eefb19-0f76-4ccb-91c5-3cedb47dcdc2")]
	[View(ViewType = ViewType.Filter, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
	[Filterable]
	...
	[NotNull]
	[Order(6)]
	[Uid("0bff88de-37d2-4b81-9529-59e1cd1e00e9")]
	...
	[Uid("4f789bd0-5464-4092-bdeb-d61d27b46da7")]
	...
	[View(ViewType = ViewType.List, ItemType = ItemType.Default, Visibility = Visibility.Hidden, ReadOnly = false)]
	[Order(7)]
	[Uid("c2aa847b-ca66-4625-b060-be7d20a4e955")]
	[NotNull]
