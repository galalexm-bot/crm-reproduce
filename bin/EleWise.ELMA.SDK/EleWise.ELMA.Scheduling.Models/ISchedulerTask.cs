...
[Uid("c423fe8a-b399-4fd9-a9a1-0bcc0e3e53bf")]
...
public interface ISchedulerTask : IEntity<long>, IEntity, IIdentified
{
	...
	[NotNull]
	[Uid("50ebbd5b-1e68-4dfa-a694-1dae4d886a5d")]
	...
	[Uid("2baa3630-66e5-48fc-82aa-bc036835b887")]
	[Order(1)]
	[Required(true)]
	...
	[View(ViewType = ViewType.Create, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
	[Uid("3d132143-f09d-49f7-950c-93bf22aafa2e")]
	[View(ViewType = ViewType.Display, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = true)]
	[Order(5)]
	[EntityProperty]
	...
	[Uid("71448c77-840b-41a3-a419-8dc728531a5f")]
	[Order(6)]
	[View(ViewType = ViewType.List, ItemType = ItemType.Default, Visibility = Visibility.Hidden, ReadOnly = false)]
	[EntityProperty]
	...
	[CanBeNull]
	[Uid("f19031d5-bd7d-4212-8ae7-936e74161d8b")]
	[Order(7)]
	...
	[Uid("18d2b6c0-9b0e-4c96-bad4-d39aa7efcbb8")]
	[NotNull]
	[View(ViewType = ViewType.List, ItemType = ItemType.Default, Visibility = Visibility.Hidden, ReadOnly = false)]
	[EntityProperty]
	[View(ViewType = ViewType.Display, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = true)]
	...
	[NotNull]
	[Order(4)]
	[Uid("d097654c-9283-46c6-96f5-8815d7e58877")]
	SchedulerTaskStatus Status { get; set; }

	[Filterable]
	[Uid("f4517829-528c-498a-8514-85dd2b1ebafa")]
	...
	[Property("eb6e8ddc-fafe-4e0e-9018-1a7667012579")]
	[Uid("8a11bbef-9964-42ba-92a2-b4dfa769e0be")]
	[View(ViewType = ViewType.List, ItemType = ItemType.Default, Visibility = Visibility.Hidden, ReadOnly = false)]
	[Order(8)]
	[EntityProperty]
