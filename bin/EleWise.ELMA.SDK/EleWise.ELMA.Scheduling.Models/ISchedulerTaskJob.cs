...
[Uid("215dd155-ef88-4b92-ab32-6c370e50340c")]
[DisplayFormat(null)]
...
public interface ISchedulerTaskJob : IEntity<long>, IEntity, IIdentified, IInheritable
{
	...
	[SystemProperty]
	[Uid("1928a6c4-c9a4-4eb5-a0a1-126ea71d849a")]
	[NotNull]
	...
	[Order(2)]
	[Uid("1ff528a6-c142-48b7-bc9f-d78e3918bc44")]
	...
	[Required(true)]
	[Order(1)]
	[Uid("722a0414-62e9-4d97-a85e-b903c1df5656")]
	...
	[View(ViewType = ViewType.Display, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = true)]
	[Order(3)]
	[Uid("ed1e23fe-1c1f-4778-9d89-d2bcc05356d5")]
	[CanBeNull]
