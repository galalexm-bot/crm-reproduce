...
[DisplayFormat(null)]
[Uid("4ea88112-1e4d-413e-9715-0a5514809607")]
...
public interface IFormMetadataItem : IEntity<long>, IEntity, IIdentified
{
	...
	[Uid("74b99335-e8f8-4be6-9cb7-809c2b6e2359")]
	[NotNull]
	[EntityProperty]
	Guid Uid { get; set; }
	...
	[Order(1)]
	[EntityProperty]
	[Uid("8fd084d9-6e36-4b91-9b84-e659370f55d3")]
	...
	[CanBeNull]
	[Order(2)]
	[Uid("962e5bed-bca7-4464-80fd-ef3d8ddbaa4d")]
	...
	[View(ViewType = ViewType.List, ItemType = ItemType.Default, Visibility = Visibility.Hidden, ReadOnly = false)]
	[EntityProperty]
	[Uid("9807c1aa-7720-4b15-8907-b5f6da823e02")]
	[View(ViewType = ViewType.Create, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
	[View(ViewType = ViewType.Display, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = true)]
	...
	[Uid("3b63a507-1de8-4c74-a1d5-3f96160bdd03")]
	[View(ViewType = ViewType.Edit, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
	[View(ViewType = ViewType.Create, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
	...
	[Order(5)]
	[Uid("8d145669-fa12-4459-b550-c31c00342633")]
	[View(ViewType = ViewType.Create, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
	...
	[Uid("9d5f972e-7748-4a46-b752-c981cff1f477")]
	[View(ViewType = ViewType.List, ItemType = ItemType.Default, Visibility = Visibility.Hidden, ReadOnly = false)]
	[EntityProperty]
	...
	[View(ViewType = ViewType.Display, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = true)]
	[Order(10)]
	[Uid("acf93cda-ee92-4344-88d9-d2e5253e3f4f")]
	[Property("1911b22d-0ce2-4743-832f-6a44cb0357fe")]
	...
	[Order(8)]
	[Uid("587dd684-6415-4126-af7b-0077267b0230")]
	...
	[Order(11)]
	[Uid("7dcc9d5f-0c40-4fc5-805f-4003057a9d70")]
	[NotNull]
