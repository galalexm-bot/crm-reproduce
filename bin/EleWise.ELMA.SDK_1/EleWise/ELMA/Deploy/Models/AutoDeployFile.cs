...
// Type: EleWise.ELMA.Deploy.Models.AutoDeployFile
...
{
  /// <summary>Описание авторазвертываемого компонента ELMA</summary>
  [Serializable]
      ...
      get
      {
        ...
        switch (1)
        {
          case 1:
            try
            {
              semanticVersion = new SemanticVersion(this.Version);
              int num = 0;
      ...
      while (true)
      {
        switch (num)
        {
          case 0:
            goto label_2;
          case 1:
            info.AddValue(z2jc63fLkugS1X8Q9N.tE1kD1vbB(-1939377524 ^ -1939350012), (object) ClassSerializationHelper.SerializeObjectByXml((object) this));
...
label_4:;
    ...
    internal static bool bDpqAJE4opEYPu7QJTXL() => AutoDeployFile.ImDiy4E4WgjfufMhh8v6 == null;

    internal static AutoDeployFile Dt0jP0E4bmO6UGOXD2dZ() => AutoDeployFile.ImDiy4E4WgjfufMhh8v6;
  }
}
