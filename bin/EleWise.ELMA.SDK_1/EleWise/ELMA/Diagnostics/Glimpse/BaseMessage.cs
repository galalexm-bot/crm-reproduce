...
// Type: EleWise.ELMA.Diagnostics.Glimpse.BaseMessage
...
{
  /// <summary>Базовое сообщение, отправляемой в Glimpse</summary>
  internal class BaseMessage : MessageBase, ITimelineMessage, ITimedMessage, IMessage
  {
    internal static BaseMessage vmEBZQEiBYqNq8mia4Qt;

    /// <summary>Смещение от начала выполнения потока</summary>
...
label_4:;
    ...
    internal static bool sNIlU1EiW0cTKXD95Zb9() => BaseMessage.vmEBZQEiBYqNq8mia4Qt == null;

    internal static BaseMessage RfE63tEioJU1tuBUNRjv() => BaseMessage.vmEBZQEiBYqNq8mia4Qt;
  }
}
