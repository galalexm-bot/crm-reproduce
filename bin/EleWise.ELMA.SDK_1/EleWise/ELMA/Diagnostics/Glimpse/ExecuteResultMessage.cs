...
// Type: EleWise.ELMA.Diagnostics.Glimpse.ExecuteResultMessage
...
{
  internal class ExecuteResultMessage : 
    BaseMessage,
    IExecutionMessage,
    ISourceMessage,
    IChildActionMessage,
...
label_4:;
    ...
    /// <summary>Дочернее действие?</summary>
    public bool IsChildAction
    {
      get => this.\u003CIsChildAction\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CIsChildAction\u003Ek__BackingField = value;
...
label_4:;
    ...
    {
      ExecuteResultMessage.GqPVdGEiE2ftDBfHxZZJ();
    ...
    internal static bool M1mXpJEih3G6t80FgG2G() => ExecuteResultMessage.HLgM6qEibsixcL6v1vTJ == null;

    internal static ExecuteResultMessage ADD755EiGot24VBymJam() => ExecuteResultMessage.HLgM6qEibsixcL6v1vTJ;

    internal static void GqPVdGEiE2ftDBfHxZZJ() => TKW1L3mlUyvXmg29jA.JJCZtPuTvSt();
  }
}
