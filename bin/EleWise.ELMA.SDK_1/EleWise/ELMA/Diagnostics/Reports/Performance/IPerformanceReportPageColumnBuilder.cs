...
// Type: EleWise.ELMA.Diagnostics.Reports.Performance.IPerformanceReportPageColumnBuilder
...
{
  /// <summary>Точка расширения построителя отчета</summary>
  [ExtensionPoint(ComponentType.All)]
  public interface IPerformanceReportPageColumnBuilder
  {
    /// <summary>Добавить метрику в отчет</summary>
