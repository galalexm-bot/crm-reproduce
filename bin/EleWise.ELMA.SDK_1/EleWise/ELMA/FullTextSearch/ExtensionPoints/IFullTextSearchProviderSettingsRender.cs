...
// Type: EleWise.ELMA.FullTextSearch.ExtensionPoints.IFullTextSearchProviderSettingsRender
...
{
  /// <summary>
  /// Интерфейс точки расширения отображения и редактирования настроек провайдера полнотекстового поиска
  /// </summary>
