...
// Type: EleWise.ELMA.FullTextSearch.Model.IIndexQueue
...
{
  /// <summary>IndexQueue</summary>
  /// <remarks>
  /// Элемент очерди индексирования для полнотекстового поиска
  /// </remarks>
  [Filterable]
  ...
  [EleWise.ELMA.Model.Attributes.Uid("2bcb7aec-2849-4e47-bbb9-4d10d2b105c5")]
  ...
  public interface IIndexQueue : IEntity<long>, IEntity, IIdentified
  {
    ...
    [EleWise.ELMA.Model.Attributes.Uid("ac7b3f5e-dbfa-4d7e-a278-def5c7fd8597")]
    Guid Uid { get; set; }

    /// <summary>Id обрабатываемого объекта</summary>
    [CanBeNull]
    [Property("d90a59af-7e47-48c5-8c4c-dad04834e6e3")]
    [Order(4)]
    [EleWise.ELMA.Model.Attributes.Uid("9d73d403-933f-422b-ad46-bae872c9a768")]
    [EntityProperty]
    ...
    /// <summary>Измененные свойства объекта</summary>
    [View(ViewType = ViewType.Display, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = true)]
    [EntityProperty]
    ...
    [View(ViewType = ViewType.List, ItemType = ItemType.Default, Visibility = Visibility.Hidden, ReadOnly = false)]
    [View(ViewType = ViewType.Edit, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
    [EleWise.ELMA.Model.Attributes.Uid("394a4b3b-c139-4123-a031-6aadf7e451a0")]
    [View(ViewType = ViewType.Filter, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
    [Property("9b9aac17-22bb-425c-aa93-9c02c5146965")]
    [Order(5)]
    string DirtyValues { get; set; }

    /// <summary>Тип элемента очереди</summary>
    ...
    [View(ViewType = ViewType.Filter, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
    [EntityProperty]
    [EleWise.ELMA.Model.Attributes.Uid("d0dfe16d-8f42-44e6-9858-2a6a40713a98")]
    [CanBeNull]
    [Order(1)]
    ...
    [Order(3)]
    [EleWise.ELMA.Model.Attributes.Uid("ac76f034-df46-45c0-9e89-7ad65789e0fb")]
    [CanBeNull]
    ...
    /// <remarks>Uid тип карточки для которой производится индексация</remarks>
    [View(ViewType = ViewType.Edit, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
    [View(ViewType = ViewType.List, ItemType = ItemType.Default, Visibility = Visibility.Hidden, ReadOnly = false)]
    [View(ViewType = ViewType.Display, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = true)]
    [View(ViewType = ViewType.Create, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
    ...
    [CanBeNull]
    [Order(2)]
    [EleWise.ELMA.Model.Attributes.Uid("fcf39d3e-72b6-437e-9c0b-de6fc64c045b")]
    [Property("eb6e8ddc-fafe-4e0e-9018-1a7667012579")]
    ...
    /// <summary>Id автора создания</summary>
    [Property("d90a59af-7e47-48c5-8c4c-dad04834e6e3")]
    [Int64Settings(FieldName = "CreationAuthorId")]
    [View(ViewType = ViewType.Create, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
    [EleWise.ELMA.Model.Attributes.Uid("6112526b-327a-4755-9332-2e813d75401a")]
    [Order(6)]
    [CanBeNull]
    [View(ViewType = ViewType.Filter, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
    [EntityProperty]
    ...
    /// <summary>Визуальные данные</summary>
    /// <remarks>
    /// Флаг наличия в индексируемых данных информации о полях влияющих на отображение в гридах.
    /// </remarks>
    [View(ViewType = ViewType.Filter, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
    [View(ViewType = ViewType.List, ItemType = ItemType.Default, Visibility = Visibility.Hidden, ReadOnly = false)]
    [CanBeNull]
    ...
    [EleWise.ELMA.Model.Attributes.Uid("e0b9b211-93c1-48b8-919a-1b6b8af228e4")]
    [EntityProperty]
    [Filterable]
    [View(ViewType = ViewType.Edit, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
    [View(ViewType = ViewType.Display, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = true)]
    ...
    /// <summary>Номер попытки выполнения</summary>
    [DisplayName(typeof (__Resources_IIndexQueue), "P_Attempt_DisplayName")]
    [View(ViewType = ViewType.Create, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
    [Order(8)]
    [Int64Settings(FieldName = "Attempt")]
    [EleWise.ELMA.Model.Attributes.Uid("69d0c84d-2511-4de1-a814-1042a5341aec")]
    [NotNull]
    [Property("d90a59af-7e47-48c5-8c4c-dad04834e6e3")]
    [View(ViewType = ViewType.Display, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = true)]
    [View(ViewType = ViewType.List, ItemType = ItemType.Default, Visibility = Visibility.Hidden, ReadOnly = false)]
