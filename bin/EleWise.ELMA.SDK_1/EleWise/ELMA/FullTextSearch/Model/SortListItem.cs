...
// Type: EleWise.ELMA.FullTextSearch.Model.SortListItem
...
{
  /// <summary>Описание поля сортировки в полнотекстовом поиске</summary>
  public class SortListItem
  {
    ...
    {
      SortListItem.pTgdWMGRS6ME1DOBFbQ2();
...
label_4:;
    ...
    internal static void pTgdWMGRS6ME1DOBFbQ2() => TKW1L3mlUyvXmg29jA.JJCZtPuTvSt();

    internal static bool wiNttVGRIggm25neq4oQ() => SortListItem.jV4yk7GRuSSZQh3b1M92 == null;

    internal static SortListItem ifYBacGRVtu8n6d4sdNB() => SortListItem.jV4yk7GRuSSZQh3b1M92;
  }
}
