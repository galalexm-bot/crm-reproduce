...
// Type: EleWise.ELMA.Model.BackgroundOperations.ICreatingBuilder
...
{
  /// <summary>
  /// Интерфейс создающего билдера, который является завершающим шагом в создании фоновой операции.
  /// </summary>
