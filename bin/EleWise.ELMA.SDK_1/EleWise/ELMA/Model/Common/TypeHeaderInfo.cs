...
// Type: EleWise.ELMA.Model.Common.TypeHeaderInfo
...
{
  /// <summary>Информация о типе</summary>
  public sealed class TypeHeaderInfo
  {
    private static TypeHeaderInfo zN1qolhqIyCQ7usJNSJg;
...
label_4:;
    ...
    /// <summary>Настройки типа</summary>
...
label_4:;
    ...
    /// <summary>Тип допускает значение Null</summary>
...
label_4:;
    ...
    internal static bool uLCYqQhqVAGZO9KR3v5L() => TypeHeaderInfo.zN1qolhqIyCQ7usJNSJg == null;

    internal static TypeHeaderInfo zkpiVShqSvUfiSDOuWlx() => TypeHeaderInfo.zN1qolhqIyCQ7usJNSJg;
  }
}
