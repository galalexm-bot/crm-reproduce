...
// Type: EleWise.ELMA.Model.Metadata.DTO.Managers.IDataClassMetadataItemDTOManager
...
{
  /// <summary>
  /// Интерфейс менеджера элементов метаданных датакласса для работы через Remoting
  /// </summary>
  public interface IDataClassMetadataItemDTOManager : IConfigurationService
  {
    /// <summary>
    /// Загрузить элемент метаданных функций по идентификатору
    /// </summary>
    /// <param name="id">Идентификатор</param>
    DataClassMetadataItemDTO Load(long id);

    /// <summary>Загрузить элемент метаданных функций</summary>
    /// <param name="id">Идентификатор</param>
    /// <returns>Заголовок метаданных функций</returns>
    DataClassMetadataItemDTO LoadOrNull(long id);

    /// <summary>
    /// Загрузить элемент метаданных функций по Uid без учета прав
    /// </summary>
