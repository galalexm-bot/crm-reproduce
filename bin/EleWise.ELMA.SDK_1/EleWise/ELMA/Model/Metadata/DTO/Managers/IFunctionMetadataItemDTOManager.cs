...
// Type: EleWise.ELMA.Model.Metadata.DTO.Managers.IFunctionMetadataItemDTOManager
...
{
  /// <summary>
  /// Интерфейс менеджера элементов метаданных функций для работы через Remoting
  /// </summary>
