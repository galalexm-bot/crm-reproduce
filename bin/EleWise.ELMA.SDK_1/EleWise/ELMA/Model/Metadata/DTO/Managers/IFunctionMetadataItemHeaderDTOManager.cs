...
// Type: EleWise.ELMA.Model.Metadata.DTO.Managers.IFunctionMetadataItemHeaderDTOManager
...
{
  /// <summary>
  /// Интерфейс менеджера заголовков метаданных функций для работы через Remoting
  /// </summary>
