...
// Type: EleWise.ELMA.Model.Metadata.DTO.Models.MetadataItemGroupDTO
...
{
  /// <summary>DTO для группы элементов метаданных</summary>
  [Serializable]
  public class MetadataItemGroupDTO : EntityDTO<long>
  {
    private static MetadataItemGroupDTO Avw1cJbgSj18ab9qXS6B;

    /// <summary>Ctor</summary>
    public MetadataItemGroupDTO()
    {
      MetadataItemGroupDTO.A9NrCybgqThxIG65IZXP();
      ...
      while (true)
      {
        switch (num)
        {
          case 1:
            goto label_3;
          default:
            this.SubGroups = new List<MetadataItemGroupDTO>();
...
label_4:;
    ...
    {
      get => this.\u003CParentId\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
...
label_4:;
    ...
    internal static void A9NrCybgqThxIG65IZXP() => TKW1L3mlUyvXmg29jA.JJCZtPuTvSt();

    internal static bool EysVqRbgiBbbM0Q2Pbxw() => MetadataItemGroupDTO.Avw1cJbgSj18ab9qXS6B == null;

    internal static MetadataItemGroupDTO DQgLItbgRv6W3WppykIZ() => MetadataItemGroupDTO.Avw1cJbgSj18ab9qXS6B;
  }
}
