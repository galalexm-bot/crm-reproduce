...
// Type: EleWise.ELMA.Model.Scripts.DTO.Models.ScriptModuleDTO
...
{
  /// <summary>DTO для модуля сценариев</summary>
  [Serializable]
  public class ScriptModuleDTO : EntityDTO<long>, IScriptModule
  {
    internal static ScriptModuleDTO hOSKrMbKTRrDLFnpxF4F;
        ...
        while (true)
        {
          switch (num2)
          {
            case 0:
              goto label_3;
            case 1:
              ScriptModuleDTO.CRTuW8bKOa0ObP5at3HW((object) this, (object) new RootCodeItemCollection());
              num2 = 2;
              continue;
            case 2:
              goto label_8;
            case 3:
              ...
              continue;
            case 4:
              ScriptModuleDTO.tLXy33bKeXdNj8PQDBm0((object) this, ScriptModuleDTO.G1cVMcbK2aTDGumR3ly5(-649342099 - -1150814748 ^ 501292327));
              num2 = 3;
              continue;
            case 5:
            ...
            case 6:
              ...
              num2 = \u003CModule\u003E\u007B3a453932\u002D0908\u002D413c\u002Db2f1\u002D639ca5a231f2\u007D.m_7b7601840955431b8667c611372f91fa != 0 ? 7 : 6;
              continue;
            case 7:
...
label_8:
        this.Namespace = (string) ScriptModuleDTO.G1cVMcbK2aTDGumR3ly5(993438473 ^ 993454171);
        num1 = 4;
      }
label_3:
      return;
label_11:;
    ...
    /// <summary>Событие при изменении исходного кода</summary>
    [XmlIgnore]
    public bool NeedUpdateSourceCode
    {
      get => this.\u003CNeedUpdateSourceCode\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CNeedUpdateSourceCode\u003Ek__BackingField = value;
...
label_4:;
    ...
    /// <summary>Файл с исходным кодом, не удаляемый при компиляции</summary>
    [XmlIgnore]
    public string SourceCodeFileName
    {
      get => this.\u003CSourceCodeFileName\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CSourceCodeFileName\u003Ek__BackingField = value;
...
label_4:;
    ...
    /// <summary>Дизайнеры конструктора сценариев</summary>
...
label_4:;
    ...
    /// <summary>
    /// Список имен требуемых сборок elma для компиляции сценария (через точку с запятой)
    /// </summary>
...
label_4:;
    ...
    /// <summary>Глобальные модули</summary>
...
label_4:;
    ...
    public override void CopyChanges(EntityDTO<long> saved)
    {
      ...
      if (!(saved is ScriptModuleDTO scriptModuleDto))
        return;
      this.Uid = scriptModuleDto.Uid;
    }

    internal static void CRTuW8bKOa0ObP5at3HW([In] object obj0, [In] object obj1) => ((ScriptModuleDTO) obj0).CodeItems = (RootCodeItemCollection) obj1;

    internal static object G1cVMcbK2aTDGumR3ly5(int _param0) => (object) z2jc63fLkugS1X8Q9N.tE1kD1vbB(_param0);

    internal static void tLXy33bKeXdNj8PQDBm0([In] object obj0, [In] object obj1) => ((ScriptModuleDTO) obj0).References = (string) obj1;

    internal static bool YcJOLDbKk75LLyPtdu0H() => ScriptModuleDTO.hOSKrMbKTRrDLFnpxF4F == null;

    internal static ScriptModuleDTO CeOxc3bKnN2BOeIuCNuT() => ScriptModuleDTO.hOSKrMbKTRrDLFnpxF4F;
  }
}
