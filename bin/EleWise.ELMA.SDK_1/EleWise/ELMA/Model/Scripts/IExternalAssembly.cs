...
// Type: EleWise.ELMA.Model.Scripts.IExternalAssembly
...
{
  /// <summary>Внешняя сборка</summary>
  [EleWise.ELMA.Model.Attributes.Uid("832bc52b-6f0d-44a9-bccb-825a89a28503")]
  [DisplayFormat(null)]
  ...
  public interface IExternalAssembly : IEntity<long>, IEntity, IIdentified
  {
    ...
    [EleWise.ELMA.Model.Attributes.Uid("4ed0d347-39e8-47a4-a729-6d3a0dae71d7")]
    Guid Uid { get; set; }

    /// <summary>Имя сборки</summary>
    [EleWise.ELMA.Model.Attributes.Uid("ce2a09b0-c48b-4641-9b31-dfef2116339d")]
    ...
    [View(ViewType = ViewType.Create, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
    [EntityProperty]
    [EleWise.ELMA.Model.Attributes.Uid("e8d5e5a1-159c-4dea-a6a5-a96ac14ec98c")]
    [Filterable]
    [View(ViewType = ViewType.Filter, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
    ...
    [Order(3)]
    [EleWise.ELMA.Model.Attributes.Uid("8dabac66-60e6-4b64-9e17-c3bfc0e1c738")]
    [EntityProperty]
    [View(ViewType = ViewType.Edit, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
    [View(ViewType = ViewType.List, ItemType = ItemType.Default, Visibility = Visibility.Hidden, ReadOnly = false)]
    [View(ViewType = ViewType.Display, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = true)]
