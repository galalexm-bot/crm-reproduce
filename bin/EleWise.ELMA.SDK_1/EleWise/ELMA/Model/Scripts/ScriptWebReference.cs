...
// Type: EleWise.ELMA.Model.Scripts.ScriptWebReference
...
{
  /// <summary>Информация о ссылке на веб-сервис</summary>
  [Serializable]
  public class ScriptWebReference
  {
    ...
    {
      ScriptWebReference.PU1GDSbRQ8iHbujITiOV();
...
label_4:;
    ...
    internal static void PU1GDSbRQ8iHbujITiOV() => TKW1L3mlUyvXmg29jA.JJCZtPuTvSt();

    internal static bool EFLBBkbREQN1KmBaArBR() => ScriptWebReference.kIOw8xbRGIHFLMStmtX9 == null;

    internal static ScriptWebReference K13bWNbRfH4fe9jgo2Fo() => ScriptWebReference.kIOw8xbRGIHFLMStmtX9;
  }
}
