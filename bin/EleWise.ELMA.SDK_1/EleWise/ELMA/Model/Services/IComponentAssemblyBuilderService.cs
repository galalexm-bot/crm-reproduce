...
// Type: EleWise.ELMA.Model.Services.IComponentAssemblyBuilderService
...
namespace EleWise.ELMA.Model.Services
{
  ...
  {
    /// <summary>Скомпилировать компонент</summary>
    /// <param name="model">Модель компиляции компонента</param>
