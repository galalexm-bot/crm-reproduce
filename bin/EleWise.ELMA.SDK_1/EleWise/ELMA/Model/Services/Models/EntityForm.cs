...
// Type: EleWise.ELMA.Model.Services.Models.EntityForm
...
{
  /// <summary>Модель обработки формы</summary>
...
label_4:;
    ...
    {
      get => this.\u003CEntity\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
...
label_4:;
    ...
    internal static bool ExWQB2bZg3s9b0eutipi() => EntityForm.BGbnKxbZrqLu3nri5tp3 == null;

    internal static EntityForm z9goXibZ5YuGSdK1p6Hb() => EntityForm.BGbnKxbZrqLu3nri5tp3;
  }
}
