...
// Type: EleWise.ELMA.Model.Transformations.Class.Transformation`3
...
namespace EleWise.ELMA.Model.Transformations.Class
{
    ...
    where TUid : class
  {
    ...
    protected override TUid ConvertUid(TUid uid) => uid;
    ...
    {
      EleWise.ELMA.Model.Transformations.Class.TransformationAdd<TItem, TTransformation, TUid> transformationAdd = new EleWise.ELMA.Model.Transformations.Class.TransformationAdd<TItem, TTransformation, TUid>();
    ...
    protected override BaseTransformation<TItem, TUid> TransformationMove(
      ...
      TUid beforeItem = null)
    {
      EleWise.ELMA.Model.Transformations.Class.TransformationMove<TItem, TTransformation, TUid> transformationMove = new EleWise.ELMA.Model.Transformations.Class.TransformationMove<TItem, TTransformation, TUid>();
    ...
    {
      EleWise.ELMA.Model.Transformations.Class.TransformationHide<TItem, TTransformation, TUid> transformationHide = new EleWise.ELMA.Model.Transformations.Class.TransformationHide<TItem, TTransformation, TUid>();
    ...
    {
      EleWise.ELMA.Model.Transformations.Class.TransformationChange<TItem, TTransformation, TUid> transformationChange = new EleWise.ELMA.Model.Transformations.Class.TransformationChange<TItem, TTransformation, TUid>();
    ...
    internal static bool TEoIjaWUUrU876ih3GTA() => Transformation<TItem, TTransformation, TUid>.OLAYiFWULZBwLsVxFJ50 == null;

    internal static object afdt73WUsayb2FTafv8V() => Transformation<TItem, TTransformation, TUid>.OLAYiFWULZBwLsVxFJ50;
  }
}
