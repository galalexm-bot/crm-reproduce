...
// Type: EleWise.ELMA.Model.Transformations.Struct.Transformation`7
...
namespace EleWise.ELMA.Model.Transformations.Struct
{
  ...
  public abstract class Transformation<TItem, TTransformation, TUid, TAdd, TMove, THide, TChange> : 
    ...
    where TUid : struct
    where TAdd : EleWise.ELMA.Model.Transformations.Struct.TransformationAdd<TItem, TTransformation, TUid>, new()
    ...
    where TChange : EleWise.ELMA.Model.Transformations.Struct.TransformationChange<TItem, TTransformation, TUid>, new()
  {
    ...
    internal static bool v7c8NpWUHdLBIuaZ4Mqt() => Transformation<TItem, TTransformation, TUid, TAdd, TMove, THide, TChange>.shXT3bWU6FnfhQTfaoGt == null;

    internal static object rv95eSWUATcy08WD7wv4() => Transformation<TItem, TTransformation, TUid, TAdd, TMove, THide, TChange>.shXT3bWU6FnfhQTfaoGt;
  }
}
