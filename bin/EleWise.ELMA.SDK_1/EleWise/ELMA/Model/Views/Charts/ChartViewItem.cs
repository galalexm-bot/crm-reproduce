...
// Type: EleWise.ELMA.Model.Views.Charts.ChartViewItem
...
{
  /// <summary>Диаграмма (базовая реализация)</summary>
  public abstract class ChartViewItem : 
    ViewItem,
    IChartViewItem,
    IDynamicViewItem,
      ...
      while (true)
      {
        switch (num)
        {
          case 1:
            goto label_2;
          case 2:
            this.LegendViewType = ViewItemChartLegendViewType.Show;
...
label_4:;
    ...
    {
      get => this.\u003CValueUid\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CValueUid\u003Ek__BackingField = value;
...
label_4:;
    ...
    public Guid NameUid
    {
      get => this.\u003CNameUid\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CNameUid\u003Ek__BackingField = value;
...
label_4:;
    ...
    {
      get => this.\u003CLegendViewType\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CLegendViewType\u003Ek__BackingField = value;
...
label_4:;
    ...
    /// <summary>
    /// Нужно ли сериализовать свойство <see cref="P:EleWise.ELMA.Model.Views.Charts.ChartViewItem.PropertyParents" />
    /// </summary>
    /// <returns></returns>
...
label_5:
    ...
    /// <summary>
    /// Нужно ли сериализовать свойство <see cref="P:EleWise.ELMA.Model.Views.Charts.ChartViewItem.PropertyUid" />
    /// </summary>
    /// <returns><c>true</c>, если нужно сериализовать</returns>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public virtual bool ShouldSerializePropertyUid() => ChartViewItem.CXaAEVotGapsWB4vqtut(this.PropertyUid, Guid.Empty);

    internal static bool oBkY2yotbX0OSd5YC5tB() => ChartViewItem.EZAIn2otoSS1cGnVq0x9 == null;

    internal static ChartViewItem zibCdkothW5jSb83rLd3() => ChartViewItem.EZAIn2otoSS1cGnVq0x9;

    internal static bool CXaAEVotGapsWB4vqtut([In] Guid obj0, [In] Guid obj1) => obj0 != obj1;
  }
}
