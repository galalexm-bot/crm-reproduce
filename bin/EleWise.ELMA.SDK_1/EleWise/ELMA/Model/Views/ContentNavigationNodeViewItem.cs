...
// Type: EleWise.ELMA.Model.Views.ContentNavigationNodeViewItem
...
{
  /// <summary>Контент-форма</summary>
  [Serializable]
  public class ContentNavigationNodeViewItem : 
    RootViewItem,
    IContainerViewItem,
    IViewItemLoading,
    IBadgeViewItem
  {
    ...
    {
      ContentNavigationNodeViewItem.UqdThLoXVTfLAP0WWqys();
...
label_4:;
    ...
    /// <summary>Многострочный заголовок</summary>
    [EleWise.ELMA.Model.Transformations.ChangeableProperty]
    [EleWise.ELMA.Globalization.Localizable]
    [DefaultValue(false)]
    public bool MultiLineCaption
    {
      get => this.\u003CMultiLineCaption\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CMultiLineCaption\u003Ek__BackingField = value;
...
label_3:
    ...
    internal static void UqdThLoXVTfLAP0WWqys() => TKW1L3mlUyvXmg29jA.JJCZtPuTvSt();

    internal static bool n34loGoXu0IkhwtwU81i() => ContentNavigationNodeViewItem.pcekqZoXZo2ia50Q4RKu == null;

    internal static ContentNavigationNodeViewItem kDL6xQoXIXplWxpunSMF() => ContentNavigationNodeViewItem.pcekqZoXZo2ia50Q4RKu;
  }
}
