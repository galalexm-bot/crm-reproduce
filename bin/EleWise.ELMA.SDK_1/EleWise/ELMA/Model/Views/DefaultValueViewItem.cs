...
// Type: EleWise.ELMA.Model.Views.DefaultValueViewItem
...
label_4:;
    ...
    {
      get => this.\u003CReferenceOnType\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CReferenceOnType\u003Ek__BackingField = value;
...
label_4:;
    ...
    /// <summary>
    /// Свойство отвечающее за связь многие ко многим
    /// Используется для ссылок на тип Сущности
    /// </summary>
...
label_4:;
    ...
    {
      DefaultValueViewItem.xEYnYQoqxoWIar2dHbcI();
    ...
    internal static bool qHyYiaoqAK1bpwBTo5Vi() => DefaultValueViewItem.DuhQKNoqHpNnPl2vZqdZ == null;

    internal static DefaultValueViewItem WKtxdloq7pgSmeiGNQS1() => DefaultValueViewItem.DuhQKNoqHpNnPl2vZqdZ;

    internal static void xEYnYQoqxoWIar2dHbcI() => TKW1L3mlUyvXmg29jA.JJCZtPuTvSt();
  }
}
