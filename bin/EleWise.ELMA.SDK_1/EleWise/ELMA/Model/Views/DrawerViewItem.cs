...
// Type: EleWise.ELMA.Model.Views.DrawerViewItem
...
namespace EleWise.ELMA.Model.Views
{
  ...
  [Serializable]
  public sealed class DrawerViewItem : RootViewItem, IViewItemLoading
  {
    internal static DrawerViewItem DdmEJvoRg0312PfP2PKL;

    /// <summary>Ctor</summary>
    public DrawerViewItem()
    {
      DrawerViewItem.uAQtQaoRYusqX8yWwBjx();
...
label_4:;
    ...
    /// <summary>Закрывать компонент по клику вне активной зоны</summary>
    public bool MaskClosable
    {
      get => this.\u003CMaskClosable\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CMaskClosable\u003Ek__BackingField = value;
...
label_4:;
    ...
    /// <summary>Затемнять при открытии</summary>
    [DefaultValue(true)]
    public bool MaskTransparent
    {
      get => this.\u003CMaskTransparent\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CMaskTransparent\u003Ek__BackingField = value;
...
label_4:;
    ...
    [DefaultValue(ViewItemComponentPlacement.Right)]
    public ViewItemComponentPlacement Placement
    {
      get => this.\u003CPlacement\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
...
label_4:;
    ...
    internal static void uAQtQaoRYusqX8yWwBjx() => TKW1L3mlUyvXmg29jA.JJCZtPuTvSt();

    internal static bool wIteo9oR5af8FL38cZgB() => DrawerViewItem.DdmEJvoRg0312PfP2PKL == null;

    internal static DrawerViewItem GD9ELeoRjZnOcibKX4aQ() => DrawerViewItem.DdmEJvoRg0312PfP2PKL;
  }
}
