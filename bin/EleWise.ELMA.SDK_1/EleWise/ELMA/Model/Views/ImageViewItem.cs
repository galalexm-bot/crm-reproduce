...
// Type: EleWise.ELMA.Model.Views.ImageViewItem
...
namespace EleWise.ELMA.Model.Views
{
  ...
  public class ImageViewItem : ViewItem
  {
    ...
    {
      ImageViewItem.PsA1DtoKpL9SOuT8Vern();
      ...
      while (true)
      {
        switch (num)
        {
          case 0:
            goto label_3;
          case 1:
            this.Size = ViewItemImageSize.Content;
...
label_4:;
    ...
    {
      get => this.\u003CShape\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
...
label_3:
    ...
    internal static void PsA1DtoKpL9SOuT8Vern() => TKW1L3mlUyvXmg29jA.JJCZtPuTvSt();

    internal static bool mC4kiFoKNmsNSsHv1HPv() => ImageViewItem.HGDoc0oK1YGZbTODuOAp == null;

    internal static ImageViewItem xJ6uo8oK334l8jnIP4vh() => ImageViewItem.HGDoc0oK1YGZbTODuOAp;
  }
}
