...
// Type: EleWise.ELMA.Model.Views.Toolbar.Button
...
namespace EleWise.ELMA.Model.Views.Toolbar
{
  ...
  [Serializable]
  public class Button : RootToolbarItem
  {
    internal static Button d3d8VXotX8SClUs0j6sr;
...
label_4:;
    ...
    {
      get => this.\u003CToolTipHeader\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CToolTipHeader\u003Ek__BackingField = value;
...
label_4:;
    ...
    public bool Checked
    {
      get => this.\u003CChecked\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CChecked\u003Ek__BackingField = value;
...
label_4:;
    ...
    public string Click
    {
      get => this.\u003CClick\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CClick\u003Ek__BackingField = value;
...
label_4:;
    ...
    [DefaultValue(null)]
    public RootViewItem RootViewItem
    {
      get => this.\u003CRootViewItem\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CRootViewItem\u003Ek__BackingField = value;
...
label_4:;
    ...
    [DefaultValue(EleWise.ELMA.Model.Views.TextType.Default)]
    public EleWise.ELMA.Model.Views.TextType TextType
    {
...
label_4:;
    ...
    internal static bool FcDKL2otTI0h05bF6KWA() => Button.d3d8VXotX8SClUs0j6sr == null;

    internal static Button D34eBqotkpKS0XWFB9MB() => Button.d3d8VXotX8SClUs0j6sr;

    internal static void Per4OgotniUrlsFZdYPf() => TKW1L3mlUyvXmg29jA.JJCZtPuTvSt();
  }
}
