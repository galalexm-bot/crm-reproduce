...
// Type: EleWise.ELMA.Runtime.Db.DbConnectionInfo
...
{
  /// <summary>Информация о подключении сервера ELMA к БД</summary>
  public class DbConnectionInfo
  {
    private static DbConnectionInfo nFJyoCW813l39AlbIEi8;

    /// <summary>Уникальный идентификатор подключения</summary>
    public Guid Uid
    {
...
label_4:;
    ...
    /// <summary>Имя сервера (компьютера)</summary>
...
label_4:;
    ...
    /// <summary>Версия SDK</summary>
    public string SDKVersion
    {
      get => this.\u003CSDKVersion\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CSDKVersion\u003Ek__BackingField = value;
...
label_4:;
    ...
    {
      get => this.\u003CLastActive\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CLastActive\u003Ek__BackingField = value;
...
label_4:;
    ...
    internal static bool dKTrLOW8NR9XhwIhTVHv() => DbConnectionInfo.nFJyoCW813l39AlbIEi8 == null;

    internal static DbConnectionInfo qQqGeWW83ZtISKnidw6Y() => DbConnectionInfo.nFJyoCW813l39AlbIEi8;
  }
}
