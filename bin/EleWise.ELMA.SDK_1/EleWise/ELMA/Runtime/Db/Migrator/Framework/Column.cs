...
// Type: EleWise.ELMA.Runtime.Db.Migrator.Framework.Column
      ...
      while (true)
      {
        switch (num)
        {
          case 1:
            goto label_3;
          default:
            this.ColumnType = new ColumnType(DbType.AnsiString);
...
label_3:;
    ...
    public Column(string name, DbType type)
    {
      ...
      while (true)
      {
        ...
        {
          case 1:
            this.ColumnType.DataType = type;
            num = \u003CModule\u003E\u007B3a453932\u002D0908\u002D413c\u002Db2f1\u002D639ca5a231f2\u007D.m_c61a4898016348629effe6c617bb4dca == 0 ? 1 : 2;
            continue;
          case 2:
            goto label_3;
          default:
      ...
      while (true)
      {
        switch (num)
        {
          ...
          case 1:
            ...
            continue;
          case 2:
            this.ColumnType.Length = new int?(size);
    ...
    public void SetColumnType(ColumnType type)
    {
      ...
      while (true)
      {
        switch (num)
        {
          case 1:
            this.ColumnType = type;
            num = \u003CModule\u003E\u007B3a453932\u002D0908\u002D413c\u002Db2f1\u002D639ca5a231f2\u007D.m_d0a035e9ae274e518bba347305cb7055 != 0 ? 3 : 1;
            continue;
          case 2:
            if (type != null)
            {
...
label_2:
      return;
label_5:
      throw new ArgumentNullException((string) Column.Mv19qPWOUP2XOVMB4xsS(-867826612 ^ -867825554));
    }

    public ColumnType ColumnType
    {
      get => this.\u003CColumnType\u003Ek__BackingField;
      protected set
      {
        int num = 1;
        while (true)
...
label_4:;
    ...
    {
      get => this.\u003CColumnProperty\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CColumnProperty\u003Ek__BackingField = value;
...
label_4:;
    ...
    public bool IsIdentity => (this.ColumnProperty & ColumnProperty.Identity) == ColumnProperty.Identity;

    public bool IsPrimaryKey => (this.ColumnProperty & ColumnProperty.PrimaryKey) == ColumnProperty.PrimaryKey;

    internal static void GldsXxWOLCw9gdRrcPXN() => TKW1L3mlUyvXmg29jA.JJCZtPuTvSt();

    internal static bool tIP54QWOj4oa2L5NFQH8() => Column.Y2bu0qWO5beuE8EtyEWJ == null;

    internal static Column ADS9F5WOYcuJDcMbFOgc() => Column.Y2bu0qWO5beuE8EtyEWJ;

    internal static object Mv19qPWOUP2XOVMB4xsS(int _param0) => (object) z2jc63fLkugS1X8Q9N.tE1kD1vbB(_param0);
  }
}
