...
// Type: EleWise.ELMA.Runtime.Db.Migrator.Framework.Table
        ...
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CIsTemporary\u003Ek__BackingField = value;
...
label_4:;
    ...
    /// <summary>Создавать счётчик для ключевой колонки.</summary>
    public bool Sequence
    {
      get => this.\u003CSequence\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
...
label_4:;
    ...
    internal static bool vP8XseW26eyoCgVax221() => Table.ieqMDXW24wRanqVKxGVj == null;

    internal static Table EYmY23W2HQ96BKM88b9s() => Table.ieqMDXW24wRanqVKxGVj;
  }
}
