...
// Type: EleWise.ELMA.Scheduling.DTO.Models.SchedulerTaskDTO
...
namespace EleWise.ELMA.Scheduling.DTO.Models
{
  [Serializable]
  public class SchedulerTaskDTO : EntityDTO<long>
  {
    private static SchedulerTaskDTO UPYIBSBTqNbbgwOkm0oH;
      ...
      while (true)
      {
        switch (num)
        {
          case 0:
            goto label_3;
          case 1:
            this.Settings = new NthIncludedDaySettings();
...
label_4:;
    ...
    public SchedulerTaskStatus Status
    {
...
label_4:;
    ...
    public NthIncludedDaySettings Settings
    {
...
label_4:;
    ...
    internal static bool L2MGbOBTKHjo10aCgOGv() => SchedulerTaskDTO.UPYIBSBTqNbbgwOkm0oH == null;

    internal static SchedulerTaskDTO mNIXStBTX36uRmjx6HOA() => SchedulerTaskDTO.UPYIBSBTqNbbgwOkm0oH;
  }
}
