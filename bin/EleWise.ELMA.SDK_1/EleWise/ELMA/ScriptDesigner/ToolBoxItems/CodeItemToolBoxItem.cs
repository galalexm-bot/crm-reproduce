...
// Type: EleWise.ELMA.ScriptDesigner.ToolBoxItems.CodeItemToolBoxItem
...
{
  /// <summary>
  /// Элемент кода в панели инструментов (базовая реализация)
  /// </summary>
  [Component]
  public abstract class CodeItemToolBoxItem : ICodeItemToolBoxItem, ICodeItemPoint
  {
    ...
    {
      get => this.\u003CToolTipFooter\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CToolTipFooter\u003Ek__BackingField = value;
...
label_4:;
    ...
    {
      get => this.\u003CToolTipBody\u003Ek__BackingField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CToolTipBody\u003Ek__BackingField = value;
...
label_4:;
    ...
    internal static bool vMelvJuUNslqFfaadHm() => CodeItemToolBoxItem.MIeQVxuLgbeqNMNRl38 == null;

    internal static CodeItemToolBoxItem qLURyCusUsR0Epddsbp() => CodeItemToolBoxItem.MIeQVxuLgbeqNMNRl38;
  }
}
