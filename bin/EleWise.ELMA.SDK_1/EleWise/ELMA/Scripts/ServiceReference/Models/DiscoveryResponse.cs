...
// Type: EleWise.ELMA.Scripts.ServiceReference.Models.DiscoveryResponse
...
{
  /// <summary>
  /// Ответ на запрос получения информации о веб-сервисе/веб-ссылке
  /// </summary>
  public class DiscoveryResponse
  {
    private static DiscoveryResponse tFbb72WBEFeiZlgVagGD;

    /// <summary>Путь до файла с сгенерированным кодом на сервере</summary>
...
label_4:;
    ...
    /// <summary>Необходима аутентификация пользователя</summary>
...
label_4:;
    ...
    /// <summary>
    /// Текст с ошибкой при получении информации о веб-сервисе
    /// </summary>
...
label_4:;
    ...
    /// <summary>Веб-сервис</summary>
    public ScriptWebReference WebReference
    {
...
label_4:;
    ...
    internal static bool qWwWboWBff9REVhKLI02() => DiscoveryResponse.tFbb72WBEFeiZlgVagGD == null;

    internal static DiscoveryResponse GidtyGWBQkBbujK2tUBQ() => DiscoveryResponse.tFbb72WBEFeiZlgVagGD;
  }
}
