...
// Type: EleWise.ELMA.ServerInfoReference.StartInformation
...
label_4:;
    ...
    {
      get => this.updateFromVersionField;
      set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.updateFromVersionField = value;
...
label_4:;
    ...
    {
      StartInformation.KxeRx8vnForR36OGGhW();
    ...
    internal static bool OgPGpgvTm4B8Il8RB8b() => StartInformation.u02ddGvXkZDmfFSlFE9 == null;

    internal static StartInformation RroekIvk2EFwHTIcvhQ() => StartInformation.u02ddGvXkZDmfFSlFE9;

    internal static void KxeRx8vnForR36OGGhW() => TKW1L3mlUyvXmg29jA.JJCZtPuTvSt();
  }
}
