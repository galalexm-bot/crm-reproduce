...
// Type: EleWise.ELMA.Services.FileWatcherEventArgs
...
namespace EleWise.ELMA.Services
{
  public class FileWatcherEventArgs : EventArgs
  {
    ...
    {
      FileWatcherEventArgs.GPxR8IBHw2KOXCdC82OC();
...
label_7:;
    ...
    {
      get => this.\u003CWatchPath\u003Ek__BackingField;
      private set
      {
        int num = 1;
        while (true)
        {
          switch (num)
          {
            case 0:
              goto label_2;
            case 1:
              this.\u003CWatchPath\u003Ek__BackingField = value;
...
label_4:;
    ...
    internal static void GPxR8IBHw2KOXCdC82OC() => TKW1L3mlUyvXmg29jA.JJCZtPuTvSt();

    internal static bool rMxlBRBHDqGnFekjaoef() => FileWatcherEventArgs.aqr63QBHaw8ShwNrLy1v == null;

    internal static FileWatcherEventArgs Rq0NuIBHtFKZnmRvVHTO() => FileWatcherEventArgs.aqr63QBHaw8ShwNrLy1v;
  }
}
