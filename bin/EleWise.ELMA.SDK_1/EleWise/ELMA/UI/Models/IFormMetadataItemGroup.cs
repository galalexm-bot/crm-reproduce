...
// Type: EleWise.ELMA.UI.Models.IFormMetadataItemGroup
...
{
  /// <summary>Группа элементов метаданных форм</summary>
  ...
  [EleWise.ELMA.Model.Attributes.Uid("0fb824f0-01de-439e-9d42-320cc59e10b6")]
  ...
  public interface IFormMetadataItemGroup : IEntity<long>, IEntity, IIdentified
  {
    ...
    [NotNull]
    [EleWise.ELMA.Model.Attributes.Uid("d0d93fa2-e3bf-459a-b41e-377866b10fa4")]
    ...
    [Required(true)]
    [EleWise.ELMA.Model.Attributes.Uid("9cb2404d-688f-4a4b-a696-3db954c38206")]
    [Order(1)]
    ...
    [NotNull]
    [Property("eb6e8ddc-fafe-4e0e-9018-1a7667012579")]
    [EleWise.ELMA.Model.Attributes.Uid("63acd8ab-8b2e-4c4f-bd83-0ab80185a203")]
    [Order(2)]
    [View(ViewType = ViewType.Create, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
    [View(ViewType = ViewType.Edit, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
    ...
    [EleWise.ELMA.Model.Attributes.Uid("c8b48748-5bac-4630-8978-037b366e82c5")]
    [Order(5)]
    [View(ViewType = ViewType.Edit, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
    [View(ViewType = ViewType.Display, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = true)]
    ...
    [EleWise.ELMA.Model.Attributes.Uid("1074c92e-02c4-432b-b5b6-bfe94f6a8a95")]
    [Order(3)]
    ...
    [Order(4)]
    [View(ViewType = ViewType.List, ItemType = ItemType.Default, Visibility = Visibility.Hidden, ReadOnly = false)]
    [EleWise.ELMA.Model.Attributes.Uid("e220f284-f451-4745-b694-a66fa2fd6577")]
    [Property("72ed98ca-f260-4671-9bcd-ff1d80235f47", "0fb824f0-01de-439e-9d42-320cc59e10b6")]
    [View(ViewType = ViewType.Create, ItemType = ItemType.Default, Visibility = Visibility.Visible, ReadOnly = false)]
