...
[Component(Order = 140)]
public class RenderWasClosedCommentHistory : IRenderInWorkflowInstanceHistory
{
	public Guid ActionUid => TaskBaseActions.TerminateGuid;
	...
	{
		string caption = ((@event.New != null) ? SR.T("Задача \"{0}\" закрыта автором", SR.T(((ITaskBase)@event.New).Subject.HtmlEncode())) : null);
