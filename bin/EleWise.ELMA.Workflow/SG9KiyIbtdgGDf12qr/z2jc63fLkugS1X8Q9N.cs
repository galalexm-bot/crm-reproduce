...
internal class z2jc63fLkugS1X8Q9N
{
	...
	internal class NifvdpthXyZS3j8XxE : Attribute
	{
		...
		{
			private static object hY1R99vVSjltw1FDhMT4;
			...
			internal static bool g3lKUcvV1EZ2GHKTBg5a()
			{
				return hY1R99vVSjltw1FDhMT4 == null;
			}

			internal static object TXlOcfvVhwV0TdqjkUfW()
			{
				return hY1R99vVSjltw1FDhMT4;
			}
		}
	...
	internal class CIKBY5Ztq9Gg4oE5VU
	{
		...
		{
			byte[] array = (byte[])YVBqQKvVz4SXAEqaJOtG(Encoding.Unicode, _0020);
			byte[] array2 = new byte[32];
			ts5a7yvAKvjDk7PqWlQ9(array2, (RuntimeFieldHandle)/*OpCode not supported: LdMemberToken*/);
			byte[] key = array2;
			byte[] array3 = (byte[])KPxxLIvAOTQsgVFK7mnn(YVBqQKvVz4SXAEqaJOtG(Encoding.Unicode, _0020));
			MemoryStream memoryStream = new MemoryStream();
			SymmetricAlgorithm symmetricAlgorithm = Q3ljUyvXm();
			symmetricAlgorithm.Key = key;
			DlEnkMvAZxxZGJLOf2cy(symmetricAlgorithm, array3);
			CryptoStream cryptoStream = new CryptoStream(memoryStream, (ICryptoTransform)xNUs23vAvEDSIK24jSmo(symmetricAlgorithm), CryptoStreamMode.Write);
			Is8VVGvAYC2obroqV6Y0(cryptoStream, array, 0, array.Length);
			JB554OvA871hcW4yVChD(cryptoStream);
			return Convert.ToBase64String((byte[])hixy7ovAsflPIAjw3O9F(memoryStream));
		}

		internal static object YVBqQKvVz4SXAEqaJOtG(object P_0, object P_1)
		{
			return ((Encoding)P_0).GetBytes((string)P_1);
		}

		internal static void ts5a7yvAKvjDk7PqWlQ9(object P_0, RuntimeFieldHandle P_1)
		{
			RuntimeHelpers.InitializeArray((Array)P_0, P_1);
		}

		internal static object KPxxLIvAOTQsgVFK7mnn(object P_0)
		{
			return erhwkCleV((byte[])P_0);
		}

		internal static void DlEnkMvAZxxZGJLOf2cy(object P_0, object P_1)
		{
			((SymmetricAlgorithm)P_0).IV = (byte[])P_1;
		}

		internal static object xNUs23vAvEDSIK24jSmo(object P_0)
		{
			return ((SymmetricAlgorithm)P_0).CreateEncryptor();
		}

		internal static void Is8VVGvAYC2obroqV6Y0(object P_0, object P_1, int P_2, int P_3)
		{
			((Stream)P_0).Write((byte[])P_1, P_2, P_3);
		}

		internal static void JB554OvA871hcW4yVChD(object P_0)
		{
			((Stream)P_0).Close();
		}

		internal static object hixy7ovAsflPIAjw3O9F(object P_0)
		{
	...
	internal class fjvIDXoHxLTGxlALSK
	{
		...
		{
			return (Stream)NWFbjNvAbLX4LZmYaCGw(PTIIvZJmfC);
		}

		internal byte[] z47It19xek(int _0020)
		{
			return (byte[])BMihFrvA5nnu7lPAvvYl(PTIIvZJmfC, _0020);
		}

		internal int NQ1IZyT0jI(byte[] _0020, int _0020, int _0020)
		{
			return ENSaqUvAgZtNg1hq5DTU(PTIIvZJmfC, _0020, _0020, _0020);
		}

		internal int wgZIumIPsF()
		{
			return IhHYK3vABYA7pSL7o9FM(PTIIvZJmfC);
		}

		internal void V26I7M2UXj()
		{
			XEpHE7vAc7hccj5VmxLs(PTIIvZJmfC);
		}

		internal static object NWFbjNvAbLX4LZmYaCGw(object P_0)
		{
			return ((BinaryReader)P_0).BaseStream;
		}

		internal static object BMihFrvA5nnu7lPAvvYl(object P_0, int P_1)
		{
			return ((BinaryReader)P_0).ReadBytes(P_1);
		}

		internal static int ENSaqUvAgZtNg1hq5DTU(object P_0, object P_1, int P_2, int P_3)
		{
			return ((BinaryReader)P_0).Read((byte[])P_1, P_2, P_3);
		}

		internal static int IhHYK3vABYA7pSL7o9FM(object P_0)
		{
			return ((BinaryReader)P_0).ReadInt32();
		}

		internal static void XEpHE7vAc7hccj5VmxLs(object P_0)
		{
	...
	private void b2qCrnKW1(byte[] _0020, byte[] _0020, byte[] _0020)
	{
		...
		for (int i = 0; i < num2; i++)
		{
			...
			uint num12 = num4;
			num4 = 0u;
			uint num13 = 407913300u;
			uint num14 = 1968694467u;
			uint num15 = 1606963814u;
			uint num16 = num12;
			uint num17 = 2112151052u;
			uint num18 = 1631265925u;
			if ((double)num15 == 0.0)
			{
				num15--;
			}
		...
		try
		{
			...
			if (pAL10SKCoC == null)
			{
				lock (bYc11bZ2yR)
				{
					...
					BinaryReader binaryReader = new BinaryReader(typeof(z2jc63fLkugS1X8Q9N).Assembly.GetManifestResourceStream("2CscbxmEplFv7psLm9.PlXVHdtWrVwcp1KgnA"));
	...
	{
		//Discarded unreachable code: IL_0ffd, IL_1102, IL_1111, IL_176b, IL_177a, IL_18ce
		int num = 243;
		...
		while (true)
		{
			...
			while (true)
			{
				...
				case 110:
				case 365:
					new z2jc63fLkugS1X8Q9N().b2qCrnKW1(array3, array4, array5);
					num2 = 29;
					if (Bftybd5KgSnBAM1O42() != null)
					{
						num2 = 17;
					}
					continue;
				case 184:
					...
					continue;
				case 34:
					array3[num6] = (byte)(array3[num6] ^ array4[num6]);
					num2 = 50;
					continue;
				case 106:
					num3 = 127 - 42;
				...
				case 23:
				{
					...
					iqEiiD9SECMeMTrSYD(cryptoStream, array5, 0, array5.Length);
					PhU9kEWSRixS8ZnRy1(cryptoStream);
					lRG1gLlTer = (byte[])cneY6Uj5YOgwqdWtXZ(stream);
					i0BC3yR4NxYN1tO1qU(stream);
					i0BC3yR4NxYN1tO1qU(cryptoStream);
					num2 = 221;
					if (Bftybd5KgSnBAM1O42() != null)
					{
						num2 = 14;
				...
				case 15:
				{
					object obj = gtSGUDnBdEfENh3PHa();
					rQlZmsH75QBQPTtBs7(obj, CipherMode.CBC);
					transform = (ICryptoTransform)Gyi6BdLEU93qfu9LNh(obj, array3, array4);
					num2 = 124;
					continue;
				}
				case 247:
				...
				case 111:
					...
					continue;
				case 79:
					array6 = (byte[])WpfpAiDV8wKO9vWfGZ(KM8Udqus0rUAQ28lwa(QDHV0iQKg));
					num2 = 88;
					if (Bftybd5KgSnBAM1O42() != null)
					{
						num2 = 87;
				...
				case 243:
				{
					...
					tZSHb8BTQS7VrAxhjF(QRAOBjg6Mmq33QeFx6(fjvIDXoHxLTGxlALSK), 0L);
					array5 = (byte[])L4HmU0P7o3GuYDeFcM(fjvIDXoHxLTGxlALSK, (int)kQJFjyc9BleImUkf1R(QRAOBjg6Mmq33QeFx6(fjvIDXoHxLTGxlALSK)));
					iCSxfUX89s6Tcrt9BK(fjvIDXoHxLTGxlALSK);
					num2 = 242;
					continue;
				}
				case 245:
				...
				case 219:
					...
					continue;
				case 124:
					stream = (Stream)EGseK3fTZ2ypZQ5uhH();
					num2 = 23;
					if (Bftybd5KgSnBAM1O42() != null)
					{
						num2 = 22;
				...
				case 345:
					...
					continue;
				case 214:
					if (!KLpUXhqfqRlEuZvA99(kFdv3R6Lkl1t5gHn0N(QDHV0iQKg), null))
					{
						num2 = 365;
						continue;
					}
	...
	internal static string tE1kD1vbB(int _0020)
	{
		if (lRG1gLlTer.Length == 0)
		{
			...
			dr5SSqLSS(QDHV0iQKg.GetManifestResourceStream("u2ymH4ORKB0n3MLc7C.6g8o3lZm0nNIwQCVqc"), _0020);
		}
		if (Pgs1HOBEQA < 75)
		{
	...
	private static byte[] s1FeCITDg(object _0020)
	{
		...
		{
			189, 146, 108, 48, 29, 87, 147, 64, 116, 114,
			43, 119, 211, 72, 150, 174, 135, 143, 134, 135,
			244, 176, 148, 41, 142, 209, 157, 40, 185, 209,
			77, 43
		};
		symmetricAlgorithm.IV = new byte[16]
		{
			93, 63, 18, 152, 57, 249, 181, 88, 250, 198,
			160, 166, 51, 190, 108, 126
		};
	...
	internal static object QRAOBjg6Mmq33QeFx6(object P_0)
	{
		return ((fjvIDXoHxLTGxlALSK)P_0).m9OIO8Q0EK();
	}

	internal static void tZSHb8BTQS7VrAxhjF(object P_0, long P_1)
	{
		((Stream)P_0).Position = P_1;
	}

	internal static long kQJFjyc9BleImUkf1R(object P_0)
	{
		return ((Stream)P_0).Length;
	}

	internal static object L4HmU0P7o3GuYDeFcM(object P_0, int _0020)
	{
		return ((fjvIDXoHxLTGxlALSK)P_0).z47It19xek(_0020);
	}

	internal static void iCSxfUX89s6Tcrt9BK(object P_0)
	{
		((fjvIDXoHxLTGxlALSK)P_0).V26I7M2UXj();
	}

	internal static void IYsruMdaWKZn3771ra(object P_0)
	{
		Array.Reverse((Array)P_0);
	}

	internal static object KM8Udqus0rUAQ28lwa(object P_0)
	{
		return ((Assembly)P_0).GetName();
	}

	internal static object WpfpAiDV8wKO9vWfGZ(object P_0)
	{
		return ((AssemblyName)P_0).GetPublicKeyToken();
	}

	internal static object gtSGUDnBdEfENh3PHa()
	{
		return Q3ljUyvXm();
	}

	internal static void rQlZmsH75QBQPTtBs7(object P_0, CipherMode P_1)
	{
		((SymmetricAlgorithm)P_0).Mode = P_1;
	}

	internal static object Gyi6BdLEU93qfu9LNh(object P_0, object P_1, object P_2)
	{
		return ((SymmetricAlgorithm)P_0).CreateDecryptor((byte[])P_1, (byte[])P_2);
	}

	internal static object EGseK3fTZ2ypZQ5uhH()
	{
		return lkp69qZGc();
	}

	internal static void iqEiiD9SECMeMTrSYD(object P_0, object P_1, int P_2, int P_3)
	{
		((Stream)P_0).Write((byte[])P_1, P_2, P_3);
	}

	internal static void PhU9kEWSRixS8ZnRy1(object P_0)
	{
		((CryptoStream)P_0).FlushFinalBlock();
	}

	internal static object cneY6Uj5YOgwqdWtXZ(object P_0)
	{
		return NiXTA2HX7((Stream)P_0);
	}

	internal static void i0BC3yR4NxYN1tO1qU(object P_0)
	{
		((Stream)P_0).Close();
	}

	internal static object kFdv3R6Lkl1t5gHn0N(object P_0)
	{
		return ((Assembly)P_0).EntryPoint;
	}

	internal static bool KLpUXhqfqRlEuZvA99(object P_0, object P_1)
	{
		return (MethodInfo)P_0 == (MethodInfo)P_1;
	}

	internal static bool qSAInybu8wWmoutk17()
	{
		return (object)null == null;
	}

	internal static object Bftybd5KgSnBAM1O42()
	{
		return null;
	}
}
