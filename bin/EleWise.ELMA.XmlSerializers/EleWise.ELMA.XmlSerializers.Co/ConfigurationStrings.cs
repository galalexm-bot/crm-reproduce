...
namespace EleWise.ELMA.XmlSerializers.Configuration;
...
internal static class ConfigurationStrings
{
	...
	{
		return string.Format(CultureInfo.InvariantCulture, "{0}/{1}", new object[2] { "system.xml.serialization", sectionName });
	}
}
