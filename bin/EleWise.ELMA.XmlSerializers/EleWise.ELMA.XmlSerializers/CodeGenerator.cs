...
internal class CodeGenerator
{
	...
	{
		LocalScope localScope = (currentScope = new LocalScope(currentScope));
	}
	...
	internal void Ldc(object o)
	{
		...
		{
			ConstructorInfo constructor2 = typeof(decimal).GetConstructor(InstanceBindingFlags, null, new Type[5]
			{
				typeof(int),
				typeof(int),
				typeof(int),
		...
		{
			ConstructorInfo constructor = typeof(DateTime).GetConstructor(InstanceBindingFlags, null, new Type[1] { typeof(long) }, null);
