	...
	public XmlAttributes(ICustomAttributeProvider provider)
	{
		...
		for (int i = 0; i < customAttributes.Length; i++)
		{
			...
			else if (customAttributes[i] is XmlAnyElementAttribute)
			{
				...
				if ((xmlAnyElementAttribute2.Name == null || xmlAnyElementAttribute2.Name.Length == 0) && xmlAnyElementAttribute2.get_NamespaceSpecified() && xmlAnyElementAttribute2.Namespace == null)
				{
