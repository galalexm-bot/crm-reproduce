...
public abstract class XmlMapping
{
	...
	public string ElementName => EleWise.ELMA.XmlSerializers.Accessor.UnescapeName(Accessor.Name);
	...
	internal static string GenerateKey(Type type, XmlRootAttribute root, string ns)
	{
		...
		return type.FullName + ":" + ((root == null) ? string.Empty : root.get_Key()) + ":" + ((ns == null) ? string.Empty : ns);
	}
