...
using EleWise.ELMA.XmlSerializers.Configuration;
...
public abstract class XmlSerializationReader : XmlSerializationGeneratedCode
{
	...
	protected void UnknownTypeAttribute(IUnknownType unknownType)
	{
		if (unknownType.Attributes == null)
		{
			unknownType.Attributes = new List<KeyValuePair<string, string>>();
		}
		unknownType.Attributes.Add(new KeyValuePair<string, string>(r.Name, r.Value));
	}

	protected void UnknownTypeNode(IUnknownType unknownType)
	{
		if (unknownType.Nodes == null)
		{
			unknownType.Nodes = new List<XmlNode>();
		}
		unknownType.Nodes.Add(ReadXmlNode(wrapped: false));
	}
