...
public class XmlSerializer
{
	...
	private static XmlSerializerNamespaces DefaultNamespaces
	{
		get
		{
			...
			{
				XmlSerializerNamespaces obj = new XmlSerializerNamespaces();
				obj.AddInternal("xsi", "http://www.w3.org/2001/XMLSchema-instance");
				obj.AddInternal("xsd", "http://www.w3.org/2001/XMLSchema");
				if (defaultNamespaces == null)
				{
					defaultNamespaces = obj;
				}
			}
	...
	public static Assembly GenerateSerializer(Type[] types, XmlMapping[] mappings, CompilerParameters parameters)
	{
		...
		return TempAssembly.GenerateAssembly(mappings, types, null, null, XmlSerializerCompilerParameters.Create(parameters, needTempDirAccess: true), list.ToArray(), new Hashtable());
	}
